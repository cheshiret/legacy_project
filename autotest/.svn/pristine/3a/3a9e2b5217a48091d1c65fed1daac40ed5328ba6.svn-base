 ...
 * @author Ssong
 */
public class DayUseVisitationReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>DayUseVisitationReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 9:04:30 PM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.reportName = "Day Use Visitation Report";
		rd.reportFormat = "XLS";
