...
/**
 * @Description:  This test case used to buy less than required qty x privilege product will not have another free privilege in to cart
 ...
 * @Date  Feb 26, 2012
 */
public class BuyXLessThanRequiredQty extends LicenseManagerTestCase{
