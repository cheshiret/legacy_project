 ...
 * @author Ssong
 */
public class WeeklyCampersReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>WeeklyCampersReportScheduler</b>
	 * Generated     : <b>Mar 5, 2010 1:48:28 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.reportName = "Weekly Campers Report";
		rd.reportFormat = "PDF";
