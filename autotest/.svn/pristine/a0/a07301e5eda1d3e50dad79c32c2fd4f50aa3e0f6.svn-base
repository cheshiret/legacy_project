 ...
 * @author Ssong
 */
public class ParkRevenueReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>ParkRevenueReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 2:57:38 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.reportFormat = "XLS";
		rd.locationID = DataBaseFunctions.getFacilityName("73494", schema);//"ACORN CAMP EAST";
