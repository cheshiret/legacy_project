...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.TransactionRestrictionRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_TransactionRestriction extends SetupCase {
	...
	public void executeSetup() {
		new TransactionRestrictionRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_transact_restrict";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Transaction Restriction");//IMPORTANT
		...
		//Transaction Restriction specific attributes
		ruleData.transaction = datasFromDB.get("Transaction");
		ruleData.transactionOccurrence = datasFromDB.get("TransactionOccurence");
		ruleData.transactionOccurrenceDays = datasFromDB.get("TransactionOccurenceDays");
		ruleData.transactionOccurrenceTime = datasFromDB.get("TransactionOccurenceTime");
	}
}
