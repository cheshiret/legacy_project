package com.activenetwork.qa.awo.testcases.regression.advanced.orms.financial.fee.calculation.fees.usefee.camping.withoutpriorcalculation.grouprate.multipleschedules.inventory;
...
public class AdvancedReservationWithNightlyRates_3 extends
	...
	public void wrapParameters(Object[] param) {
		...
		feeData.bookDate = "Thu May 20 2010";
		feeData.arriveDate = "Wed May 26 2010";
		feeData.departureDate = "Fri Jun 04 2010";
		feeData.nights.add("6");
		feeData.nights.add("3");
		feeData.time.add("5/26/2010");
		feeData.time.add("6/01/2010");
		String[] cond1 = { "occpRange", "1", "", "6", "5/26/2010" };
		String[] cond2 = { "vehRange", "2", "", "6", "5/26/2010" };
