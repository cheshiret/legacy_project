 ...
 * @author vzhao
 */
public class UpdateUserAccount_NH extends WebTestCase
{
	/**
	 * Script Name   : <b>UpdateUserAccount_NH</b>
	 * Generated     : <b>Nov 26, 2009 8:44:56 PM</b>
	 * Description   : Functional Test Script
	...
	public void execute() {
		...
		//update email
		String newEmail = web.generateNewWebEmail("nh", env);
	...
	public void wrapParameters(Object[] param) {
		...
		String email = web.generateNewWebEmail("nh", env); //for private lable
