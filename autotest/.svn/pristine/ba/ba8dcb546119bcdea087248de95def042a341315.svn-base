 ...
 * @author Ssong
 */
public class UnDistributedFundsforGiftCardReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>UnDistributedFundsforGiftCardReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 4:22:43 AM</b>
	 * Description   : Functional Test Script
