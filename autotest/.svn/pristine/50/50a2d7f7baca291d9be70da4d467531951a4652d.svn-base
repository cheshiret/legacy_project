...
public class VerifySelectionCriteriaForPermits extends ResourceManagerTestCase{
	...
	private void verifySelectionCriteriaCorrect(){
		...
		if(!rd.reservationStatus.contains("All")||!rd.reservationStatus.contains("Reserved")||!rd.reservationStatus.contains("Issued")||!rd.reservationStatus.contains("Awarded")){
		...
		if(!rd.dateType.contains("Order Date")||!rd.dateType.contains("Entry Date")){
