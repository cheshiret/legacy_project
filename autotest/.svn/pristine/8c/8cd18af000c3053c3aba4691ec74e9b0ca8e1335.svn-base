 ...
 * Basic workflow to add new instructor and then to verify 
 ...
 * @LinkSetUp:
 * @SPEC:
 * Add a new Instructor [TC:109733]
 ...
 * @Date  Mar 14, 2014
 */
public class AddNewInstructor extends LicenseManagerTestCase {
	...
	public void execute() {
		...
		cust.instructorNum = lm.getCustomerNumByCustName(cust.lName, cust.fName, schema);
	...
	public void wrapParameters(Object[] param) {
		...
		cust.instructorType = "InstructorType_A";
		cust.hPhone = "4088122485";
		cust.bPhone = "4088654789";
		cust.mPhone = "4088000000";
		cust.fax = "02145689";
		cust.email = "AddInstructor@basic.com";
		...
		cust.identifier.identifierNum = "TC109733";
		...
		ch2.user = DataBaseFunctions.getLoginUserName(login.userName);
		ch2.location = login.location.split("/")[1].trim();
	}
}
