 ...
 * @author Ssong
 */
public class RAFeesInvoicedwithCustomerBalanceScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>RAFeesInvoicedwithCustomerBalanceScheduler</b>
	 * Generated     : <b>Mar 4, 2010 3:12:38 AM</b>
	 * Description   : Functional Test Script
