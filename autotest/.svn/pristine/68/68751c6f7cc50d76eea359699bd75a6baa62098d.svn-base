 ...
 * @author Ssong
 */
public class FieldPermitNumberDailyReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>FieldPermitNumberDailyReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 9:34:33 PM</b>
	 * Description   : Functional Test Script
