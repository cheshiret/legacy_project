 ...
 * @Date  Nov 10, 2011
 */
public class RedirectToHomeAfterClearSearch_05 extends RecgovTestCase{
	...
	public void verifySearchCriteriaSwitchBetweenPages(){
		...
		//1: click 'clear search' switch to 'My Account' Tab, then switch to "home" Tab.
...
//		singInPg.waitLoading();	
		...
		//2.1: setup search criteria on home page without click search button.
