 ...
 * @author Ssong
 */
public class TransactionFeeReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>TransactionFeeReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 4:13:56 AM</b>
	 * Description   : Functional Test Script
