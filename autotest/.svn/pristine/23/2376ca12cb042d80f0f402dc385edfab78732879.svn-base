...
/**
 * 
 * @Description: Verify the system displays correct error message when editing the specified License/Fiscal Year From
 * is not "All" and the specified License/Fiscal Year and To entries overlap with the License/Fiscal Year From and To entriesin
 * an existing Product Pricing record for the same Product that is also "Active" and has the same values as this record 
 * for the follow: Location Class and (if applicable) Purchase Type
 * @Preconditions:
 ...
 * @Date  Sep 1, 2011
 */
public class ConflictWithExistRecord_4 extends LicMgrEditProductPricingTestCase {
	...
	public void wrapParameters(Object[] param) {
		VERIFY_EDIT_LICYEAR_NOTALL_OVERLAP_CONFLICT_WITH_EXISTING_LICYEAR_ACTIVE_RECORD = true;
