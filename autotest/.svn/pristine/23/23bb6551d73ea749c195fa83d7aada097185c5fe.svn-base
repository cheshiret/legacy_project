...
/**
 * @Description: Search alert in note&alert sub page of privilege order detail page.
 * @Preconditions:
 ...
 * @Date  Oct 17, 2012
 */
public class SearchAlert extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		cust.lName = "TEST-TransferRule88";
		cust.fName = "QA-TransferRule88";
		cust.identifier.identifierType = "MDWFP #";
		cust.identifier.identifierNum = lm.getCustomerNumByCustName(cust.lName, cust.fName, schema);
		cust.residencyStatus = "Non Resident";

		noteAndAlertInfo.type = "Alert";// Don't change this data.
		noteAndAlertInfo.startDate = DateFunctions.getDateAfterToday(-1, timeZone);
		noteAndAlertInfo.endDate = DateFunctions.getDateAfterToday(6, timeZone);
		noteAndAlertInfo.text = "Add new alert to privilege order for search.";
