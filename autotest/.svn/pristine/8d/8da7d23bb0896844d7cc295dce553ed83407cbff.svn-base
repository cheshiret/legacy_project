 ...
 * @Date  Sep 21, 2011
 */
public class BusinessRules_SpecifiedStayStart extends WebTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		bd.arrivalDate = this.getArrivalDateForLottery();//hard code arrival date to Saturday, special start is Sunday
		bd.lengthOfStay = "4";
		bd.contractCode = "NY";
	}
