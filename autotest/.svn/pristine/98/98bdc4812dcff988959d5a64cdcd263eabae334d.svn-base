...
/**
 * @Description: This case was designed for verify supply pricing list  
 * @Preconditions:
...
public class ViewPricingList extends LicMgrViewProductPricingListTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		pricing.prodCode = "B12";
		//search critical
		pricing.status = "Active";
		pricing.locationClass = "All";

		pricingInfo[0] = new PricingInfo();
		pricingInfo[0].status = OrmsConstants.ACTIVE_STATUS;
		...
		pricingInfo[1].status = OrmsConstants.ACTIVE_STATUS;
		...
		pricingInfo[2].status = OrmsConstants.ACTIVE_STATUS;
