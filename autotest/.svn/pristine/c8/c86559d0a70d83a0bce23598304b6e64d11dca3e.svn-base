...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaxNumOfOrdersWithinABookingPeriodRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaxNumOfOrdersWithinABookingPeriod extends SetupCase {
	...
	public void executeSetup() {
		new MaxNumOfOrdersWithinABookingPeriodRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_max_n_ord_in_bk_perd";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Number Of Orders Within a Booking Period");//IMPORTANT
		...
		//Maximum Number Of Orders Within a Booking Period specific attributes
		ruleData.maximumNumberOfOrdersWithinABookingPeriod = datasFromDB.get("MAXNUMORDINBKINGPERIOD");
