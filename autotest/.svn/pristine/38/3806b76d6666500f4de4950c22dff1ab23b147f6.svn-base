 ...
 * @author Ssong
 */
public class TourFeeAnalysisReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>TourFeeAnalysisReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 4:16:54 AM</b>
	 * Description   : Functional Test Script
