...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaxNumOfConcurrentReservationsForSameCustPassNumRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaxNumOfConcurrentReservationsForSameCustPassNum extends SetupCase {
	...
	public void executeSetup() {
		new MaxNumOfConcurrentReservationsForSameCustPassNumRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_max_n_cores_sm_cusps";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Number Of Concurrent Reservations for Same Customer Pass Number");//IMPORTANT
		...
		//Maximum Number Of Concurrent Reservations for Same Customer Pass Number specific attributes
		ruleData.maximumNumberOfConcurrentReservationsForSameCustomerPassNumber = datasFromDB.get("MAXNUMCONRESCUSTPASSNUM");
	}
}
