...
/**
 * 
 * @Description:This case is used to verify Add a HIP Reporting Schedule
 * @Preconditions:
 * @SPEC:TC:019648
 * @Task#:Auto-1304
...
public class AddHIPReportingSchedule_Normal  extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		reportingScheduleInfo.setLicenseYear(String.valueOf(Integer.valueOf(lm.getFiscalYear(schema)) + 2));
		reportingScheduleInfo.setPeriodStartDate(DateFunctions.getDateAfterGivenMonth(DateFunctions.getToday(timeZone), 23));
