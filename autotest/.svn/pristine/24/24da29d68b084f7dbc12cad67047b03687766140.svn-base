...
/**
 * 
 * @Description: Verify add Tax info on Transaction fee--percent
 * 
 * @Preconditions:1. privilege product:103
 * 
 * @LinkSetUp:
 * 
 ...
 * @Date May 6, 2014
 */
public class AddTransactionFeeTax_Percent extends LicenseManagerTestCase {
	...
	public void execute() {
		...
		lm.gotoAddTaxPage(pricing.id, false);
		// verify priceInfo
		this.verifyTaxInfoForTransactionFee(pricing.transactionTaxes, false);
		// verify in DB
		this.verifyTaxInfoInDB(pricing.transactionTaxes, pricing.prodCode,
				FEETYPE_TRANFEE, false, schema);
