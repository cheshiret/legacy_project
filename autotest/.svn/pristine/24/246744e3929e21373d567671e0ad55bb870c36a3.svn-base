 ...
 *              5. verify message
 * @LinkSetUp:d_hf_add_privilege_prd:id=2780
 *            d_hf_add_cust_profile:id=3070
 * @SPEC:Reactivate Privilege - "Customer Demographic" rule violation [TC:004619] step4
 * @Task#:Auto-2134
 * 
 * @author Vivian
 * @Date  Apr 9, 2014
 */
public class Reactivate_CustDemoAgeOnPurchaseDate_Most extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		privilege.code = "RP6";
		privilege.name = "ReactivatePriOrd06";
		...
		cust.identifier.identifierNum="ReactivePri04";
