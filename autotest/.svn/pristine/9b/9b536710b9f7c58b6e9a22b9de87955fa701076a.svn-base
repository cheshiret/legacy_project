 ...
 * @author Ssong
 */
public class SeasonSummaryReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>SeasonSummaryReportScheduler</b>
	 * Generated     : <b>Mar 5, 2010 1:01:19 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.reportName = "Season Summary Report";
		rd.reportFormat = "PDF";
