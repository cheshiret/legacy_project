...
/**
 * @Description:This cases verified flow for validation of add a tax schedule for vendor fee
 * @LinkSetUp:  d_hf_add_activity:id=410(ACTIVITY_NAME='Activity For Tax Schedule 13')
 * @SPEC:[TC:110570] Add Tax Shcedule for Vendor Fee   
 * @Task#: Auto-2137
 * @author Phoebe
 * @Date  May 19, 2014
 */
public class Validation_VendorFee extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		duplicateSchedule.feeType = "Vendor Fee"; //This is the test point, can not be changed
