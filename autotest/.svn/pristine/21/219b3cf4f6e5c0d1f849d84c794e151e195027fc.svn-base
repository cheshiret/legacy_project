 ...
 * @author Ssong
 */
public class SiteNotesAndAlertsReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>SiteNotesAndAlertsReportScheduler</b>
	 * Generated     : <b>Mar 5, 2010 1:29:54 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.reportName = "Site Notes and Alerts";
		rd.reportFormat = "PDF";
