 ...
 * @author QA
 */
public class UpdateUserAccount_MD extends WebTestCase
{
	/**
	 * Script Name   : <b>UpdateUserAccount_MD</b>
	 * Generated     : <b>Apr 22, 2010 4:32:04 AM</b>
	 * Description   : Functional Test Script
	...
	public void execute() {
		...
		//update email
		String newEmail = web.generateNewWebEmail("md", env);
	...
	public void wrapParameters(Object[] param) {
		...
		String email = web.generateNewWebEmail("md", env); //for private lable
