...
/**
 * @Description:This use case to view the assigned Privilege Question of existed Question.
...
public class ViewQuestionAssignmentsToPrivilege extends LicenseManagerTestCase {
	...
	public void execute() {
		...
		// go to Privilege page
		lm.gotoPrivilegeQuestionPgFromTopMenu(privilege.privilegeId);
		...
		for(int i=0; i<questions.length; i++) {
			...
			locationClassesAndIDsList.add(lm.safeAddQuestionsForProduct(question, new LicenseManager.QuestionCompare() {
				...
				public String exist(QuestionInfo question) {
					LicMgrPrivilegeQuestionPage questionPrivilegePage = LicMgrPrivilegeQuestionPage
							.getInstance();
					return questionPrivilegePage.getProductQuestionId(3, question.locationClass);
				}
			}));
		}
		...
		// get from UI
		List<List<String>> currentAssignmentRecords = questionAssignmentPg.getAllQuestionAssignments(true,privilege.code);
	...
	public void wrapParameters(Object[] param) {
		...
		privilege.privilegeId = "135";
		privilege.code = "135";
		privilege.name = "NR FRESHWATER FISHING";

		question.proCode = privilege.code;
		question.productType = "Privilege";
		...
		questions[0].replacementOption = "Required";
		questions[0].transfterOption = "Don't Ask";
		...
		questions[0].replacementOption = "Optional";
		questions[0].transfterOption = "Don't Ask";
		...
		questions[2].originalOption = "Don't Ask";
		questions[0].replacementOption = "Required";
		questions[0].transfterOption = "Optional";
