...
/**
 * @Description:(P) State + 'Camping & Lodging' + 'RV sites'
 ...
 * @Date  Mar 12, 2012
 */
public class AvailabilityCompareWithRA_Camp extends RecgovTestCase {
...
//		searchData.selectedAutoCompletedOption = searchData.whereTextValue;
		...
		searchData.lookFor = bd.siteType;
