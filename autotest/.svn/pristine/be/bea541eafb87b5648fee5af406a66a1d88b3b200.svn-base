 ...
 *              5. verify message
 * @LinkSetUp:d_hf_add_privilege_prd:id=2760
 *            d_hf_add_cust_profile:id=3050
 * @SPEC:Reactivate Privilege - "Customer Demographic" rule violation [TC:004619] step2
 * @Task#:Auto-2134
 * 
 * @author Vivian
 * @Date  Apr 9, 2014
 */
public class Reactivate_CustDemoAgeOnValidDate_Least extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		privilege.code = "RP4";
		privilege.name = "ReactivatePriOrd04";
		...
		cust.identifier.identifierNum="ReactivePri02";
