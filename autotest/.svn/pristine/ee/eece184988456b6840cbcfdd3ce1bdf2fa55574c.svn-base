 ...
 * @author Ssong
 */
public class CancelledTourReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>CancelledTourReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 6:01:08 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.reportFormat = "XLS";
		rd.facilityLocID = "YOUNG LAKE (SOUTH) CABIN";
