...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaxNumOfReservationsWithTheSameStartDateRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaxNumOfReservationsWithTheSameStartDate extends SetupCase {
	...
	public void executeSetup() {
		new MaxNumOfReservationsWithTheSameStartDateRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_max_n_res_sm_st_dat";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Number Of Reservations With The Same Start Date");//IMPORTANT
		...
		//Maximum Number Of Reservations With The Same Start Date specific attributes
		ruleData.maximumNumberOfReservationsWithSameStartDate = datasFromDB.get("MAXNUMRESWITHSAMESTARTDATE");
	}
}
