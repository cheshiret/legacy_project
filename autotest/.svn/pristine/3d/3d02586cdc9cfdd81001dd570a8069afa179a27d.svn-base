 ...
 * @Date  Nov 10, 2011
 */
public class SecondSearchOnResult_03 extends RecgovTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		errorMsg = "We're unable to tell where you wanted to search. Did you mean any of the following?";
		
		bd.isUnifiedSearch = this.isUnifiedSearch();
		bd.whereTextValue = "NORTH POLE, AK 99705, USA";
...
//		suggestPg.verifySuggestionMessage(errorMsg);
