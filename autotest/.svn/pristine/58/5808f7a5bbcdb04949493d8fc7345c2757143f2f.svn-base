...
/**
 * 
 * @Description:This case is used to verify Add a group hunt permit
 * Blocked by DEFECT-36755(Permit info is not correct at list page)
 * @Preconditions:
 * Should have an hunt:
 * hunt code = "HuntPermitGroup";
...
public class AddHuntPermit_Group extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		hunt.setHuntCode("HuntPermitGroup");
		hunt.setDescription("HuntPermitGroup");
