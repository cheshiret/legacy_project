...
/**
 * @Description:This case is used to verify ui for activity during add vendor fee in finance manager
 * @LinkSetUp:  d_assign_feature:id=5722
 *              d_hf_add_facility:id=10
 *              d_hf_add_facility_prd:id=10
 *              d_hf_add_instructor:id=10
 *              d_hf_add_activity:id=180
 * @SPEC:[TC:109715] Add Vendor Fee Schedule for Activity Product 
 * @Task#: Auto-2135
 * @author Phoebe Chen
 * @Date  April 22, 2014
 */
public class VerifyUI_VendorFee_FNM extends FinanceManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		schedule.feeType = "Vendor Fee";
		
		schedule.productGroup = "FeeAddEditGroup";
		schedule.product = "Activity fee 15";
