 ...
 * @Date  Mar 19, 2012
 */
public class FromDatePlusValidYears_DatePrompt extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		privilege.code = "DP2";
		privilege.name = "CalculateValidToDate_4";
		privilege.purchasingName = "DP2-CalculateValidToDate_4";
