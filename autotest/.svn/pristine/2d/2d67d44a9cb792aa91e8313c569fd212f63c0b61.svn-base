...
/**
 * 
 * @Description: verify order cart and order summary page when purchasing Ledger pack inventory
 * @Preconditions: production data: 21-Ledger Pack
 ...
 * @Date  May 28, 2014
 */
public class PurchaseInventory_Ledger extends LicenseManagerTestCase {
