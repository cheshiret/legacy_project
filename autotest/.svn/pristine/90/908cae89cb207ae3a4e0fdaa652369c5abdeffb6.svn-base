...
/**
 * @Description: Reverse Duplicate registration from license manager, verify order cart info and order summary info 
 * @Preconditions: 
 ...
 * 
 */
public class OrderCartAndSummary_ReverseDupReg extends LicenseManagerTestCase{
	...
	private String productItemInfo,vehicleInfo,vehicleMiInfo,reverseMarkInfo,licenseYear;
	...
	public void wrapParameters(Object[] param) {
		...
		vehicle.type = "Boat";
		vehicle.hullIdSerialNum = "OrdCartRDR"+DataBaseFunctions.getEmailSequence();
