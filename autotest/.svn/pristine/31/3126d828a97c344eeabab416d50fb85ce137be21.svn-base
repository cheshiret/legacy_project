 ...
 * @author Ssong
 */
public class DailyArrivalReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>DailyArrivalReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 6:30:38 AM</b>
	 * Description   : Functional Test Script
