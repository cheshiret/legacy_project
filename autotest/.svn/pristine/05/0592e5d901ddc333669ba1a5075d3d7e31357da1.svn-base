...
//
///**  
// * @Description:  pos product supplier details page.
// * @Preconditions:  
// * @SPEC:  
// * @Task#: Auto-972
// * @author jwang8  
// * @Date  Mar 29, 2012   
// */
//public class InvMgrProductSupplierDetailsPage extends InvMgrPOSSupplierCommonPage {
//	private static InvMgrProductSupplierDetailsPage instance = null;
//
//	protected InvMgrProductSupplierDetailsPage() {
//
//	}
//
//	public static InvMgrProductSupplierDetailsPage getInstance() {
//		if (null == instance) {
//			instance = new InvMgrProductSupplierDetailsPage();
//		}
//		return instance;
//	}
//
