...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.SpecifiedStayStartRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.DateFunctions;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_SpecifiedStayStart extends SetupCase {
	...
	public void executeSetup() {
		new SpecifiedStayStartRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_specified_stay_start";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Specified Stay Start");//IMPORTANT
		...
		if(!StringUtil.isEmpty(datasFromDB.get("EffectiveDateAfterToday"))) {
			ruleData.effectiveDate = DateFunctions.getDateAfterToday(Integer.parseInt(datasFromDB.get("EffectiveDateAfterToday")));
		}

		//Specified Stay Start specific attributes
