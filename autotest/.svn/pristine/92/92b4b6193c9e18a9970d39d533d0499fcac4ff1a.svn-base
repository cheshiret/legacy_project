...
public class SearchCustomerProfileByIdentifier extends LicenseManagerTestCase{
	...
	public void execute() {
		...
		//verify search customer by identifier
		custSearchPg.searchCustomerByIdnetifier("MS Drivers License", "IDF222221", "Individual");
		custSearchPg.verifyKnownCustNumInSearchList(custNumForIndividual, true);
		custSearchPg.verifySearchCustomerProfileResult(cust);
		
		//Search by identifier type and number(case-insensitive,ignoring dashes,ignoring embedded spaces)
		custSearchPg.searchCustomerByIdnetifier("MS Drivers License", "I df222221-", "Individual");
		custSearchPg.verifyKnownCustNumInSearchList(custNumForIndividual, true);
		custSearchPg.verifySearchCustomerProfileResult(cust);
		
		//Search by identifier type and state
		searchCust.identifier.identifierType = "MS Drivers License";
