...
public class LicMgrLotteryStoreAssignmentsPage extends LicMgrLotteryProductDetailsPage  implements ILicMgrProductAgentAssignmentsPage {
	
	private static LicMgrLotteryStoreAssignmentsPage _instance = null;
	
	public static LicMgrLotteryStoreAssignmentsPage getInstance() {
		if(null == _instance) {
			_instance = new LicMgrLotteryStoreAssignmentsPage();
		}
