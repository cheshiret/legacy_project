 ...
 * @author Ssong
 */
public class POSProductSoldDetailReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>POSProductSoldDetailReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 2:39:21 AM</b>
	 * Description   : Functional Test Script
