...
public class VerifySalesLocationWeb extends ResourceManagerTestCase{
	...
	public void execute() {
		...
		rptCriteriaPg.selectSalesChannel("Web");
		rptCriteriaPg.waitLoading();
		rm.VerifyReportSelectionCriteria("SalesChannel", salesChannel, "Web", salesChannel.get(0));
	...
	public void reportSectionInfo(){
		...
		salesLocation.add("http://raon-web1.qa.reserveamerica.com:5001/");
		salesLocation.add("rec.gov.com");
		salesLocation.add("www.reserveusa.com");
		//List<String> salesLocation = new ArrayList<String>();
