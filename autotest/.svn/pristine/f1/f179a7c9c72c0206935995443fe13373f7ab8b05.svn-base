 ...
 * @author Ssong
 */
public class CustomerAgingReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>CustomerAgingReportScheduler</b>
	 * Generated     : <b>Mar 3, 2010 9:13:55 PM</b>
	 * Description   : Functional Test Script
