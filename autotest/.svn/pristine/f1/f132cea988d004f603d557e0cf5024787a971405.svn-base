...
/**
 * @Description: This case was designed to verify edit business rule for rule category: Suspension/Revocation
 ...
 * @Date  Mar 28, 2012
 */
public class Edit_3 extends LicenseManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		originalRuleInfo.ruleCategory = "Suspension/Revocation";
		originalRuleInfo.name = "Customer cannot have parameter SUSPENSION type on file (Deny Sale)";
		...
		originalRuleInfo.parameters[0].suspensionType = "Bad Check Suspension";
