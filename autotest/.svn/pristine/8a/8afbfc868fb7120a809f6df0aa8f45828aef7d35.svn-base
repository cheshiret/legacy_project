...
public class NewOrder_RuleAttrSetFalse_Vehicle extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		vehicle.type = "Boat";
		vehicle.hullIdSerialNum = "EnfMinPayFalse"+DataBaseFunctions.getEmailSequence();
