 ...
 * @author Ssong
 */
public class POSProductSoldSummaryReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>POSProductSoldSummaryReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 2:43:21 AM</b>
	 * Description   : Functional Test Script
