 ...
 * @author QA
 */
public class ParkProfileReport_SectionB extends ResourceManagerTestCase{
	/**
	 * Script Name   : <b>RM_rptParkProfileReport_SectionB</b>
	 * Generated     : <b>Jul 21, 2009 6:07:21 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.facilityID = "CROFT";
		rd.reportSection = "Section B - All";
