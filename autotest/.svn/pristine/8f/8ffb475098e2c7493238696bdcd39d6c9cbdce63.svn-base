 ...
 * @Description:
  * @Description:
	...
	Sample data:
 	NORTH POLE, AK 99705, USA ( select Day use )  - No matching results found
 ...
 * @Date  Nov 10, 2011
 */
public class RedirectToHomeAfterClearSearch_03 extends RecgovTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		bd2.interestInValue = "-- Please Select --";
	}
