...
/**
 * @Description:This case is used to verify ui for activity during add transaction fee in finance manager
 * @LinkSetUp:  d_assign_feature:id=5722
 *              d_hf_add_facility:id=10
 *              d_hf_add_facility_prd:id=10
 *              d_hf_add_instructor:id=10
 *              d_hf_add_activity:id=170
 * @SPEC:[TC:109718] Add Transaction Fee Schedule for Activity Product 
 * @Task#: Auto-2135
 * @author Phoebe Chen
 * @Date  April 22, 2014
 */
public class VerifyUI_TransactionFee_FNM extends FinanceManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		schedule.product = "Activity fee 14";
