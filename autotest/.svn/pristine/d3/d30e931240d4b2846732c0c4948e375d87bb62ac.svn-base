 ...
 * @author Ssong
 */
public class CentralDepositConsolidatedReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>CentralDepositConsolidatedReportScheduler</b>
	 * Generated     : <b>Mar 2, 2010 1:32:48 AM</b>
	 * Description   : Functional Test Script
  ...
  public void wrapParameters(Object[] param) {
	...
	rd.reportFormat = "XLS";
	rd.agencyID = "BLM";
	rd.facilityHQID = "FISHERMENS BEND";
