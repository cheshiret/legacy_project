 ...
 * @author vzhao
 */
public class UpdateUserAccount_NY extends WebTestCase
{
	/**
	 * Script Name   : <b>UpdateUserAccount_NY</b>
	 * Generated     : <b>Nov 26, 2009 8:45:08 PM</b>
	 * Description   : Functional Test Script
	...
	public void execute() {
		...
		//update email
		String newEmail = web.generateNewWebEmail("ny", env);
	...
	public void wrapParameters(Object[] param) {
		...
		String email = web.generateNewWebEmail("ny", env); //for private lable
