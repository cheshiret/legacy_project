...
//	private String errorMsg = "Your arrival day has to be within 30 day(s) from today. Please choose an arrival date on or before";
	...
	public void execute() {
		web.checkAndReleaseInventory(schema, DateFunctions.getToday(), 45, false, bd.siteID);
		 ...
		 */
		web.updateDateInSiteDetailPg(DateFunctions.getDateAfterToday(41), "3");
		web.verifyBusinessRuleEffectiveAtSiteDetailPage(ruleName, DateFunctions.getDateAfterToday(41), 3, "unavailable");
		 ...
		 */
		web.updateDateInSiteDetailPg(DateFunctions.getDateAfterToday(31), "10");
