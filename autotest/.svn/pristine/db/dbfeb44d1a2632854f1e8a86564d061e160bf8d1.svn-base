 ...
 * @author vzhao
 */
public class CancelRAResFromPL_NH extends WebTestCase
{
	/**
	 * Script Name   : <b>CancelRAResFromPL_NH</b>
	...
	public void execute() {
		web.checkAndReleaseInventory(schema, bd.arrivalDate, 3, false, bd.siteID);
	  	// book a reservation from RA for NH state
		web.invokeURL(url);
		web.signIn(email, pw);
		...
		// verify this order and cancel it from NH private site
