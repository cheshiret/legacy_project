...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaxConsecutiveStayRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaxConsecutiveStay extends SetupCase {
	private LoginInfo login = null;
	private RuleDataInfo ruleData = null;
	
	@Override
	public void executeSetup() {
		new MaxConsecutiveStayRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_max_consecutive_stay";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Consecutive Stay");//IMPORTANT
		...
		//Maximum Consecutive Stay specific attributes
		ruleData.length = datasFromDB.get("LengthOfStay");
		ruleData.unit = datasFromDB.get("Unit");
		ruleData.minimumTimeAwayLength = datasFromDB.get("MinimumTimeAwayLength");
		ruleData.minimumTimeAwayUnit = datasFromDB.get("MinimumTimeAwayUnit");
	}
}
