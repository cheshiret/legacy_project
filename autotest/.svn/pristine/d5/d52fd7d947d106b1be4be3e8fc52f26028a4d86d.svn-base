 ...
 * @author Ssong
 */
public class VehiclePermitsReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>VehiclePermitsReportScheduler</b>
	 * Generated     : <b>Mar 5, 2010 1:44:34 AM</b>
	 * Description   : Functional Test Script
