 ...
 * use the voucher as payment. It is for vehicle in H&F
 * @Preconditions:
 * 1. Make sure the auto approval config is active for the sales location. 
 * 2. Make sure the voucher "TESTVEHICLE" exists.
 * 3. Make sure the customer 'QA-Refund, Test-Refund' and the vehicle 'WLV - VehicleForVoid' exist.
 ...
 * @Date  Jun 5, 2012
 */
public class ProcessAndPostUseOfVoucherAsPayment_Vehicle extends
	...
	public void execute() {
		...
		// Make a vehicle order and reverse the order to create a new voucher
		...
		// Make another vehicle order and use the voucher as payment
...
//		vehicle.type = "Boat";
		...
		//this value should be equal to the record in the 'AddVehicleProduct.datapool'
		RegistrationInfo registration = new RegistrationInfo();
		registration.product = "WLV - VehicleForVoid";
		...
		voucherProgramName = "TESTVEHICLE";
