 ...
 * @Date  Mar 12, 2012
 */
public class FromDatePlusValidYears_NoDatePrompt extends LicenseManagerTestCase{
	...
	private void verifyPrivilegeValidToDateCalculate(String pri_nums){
		...
		if(mins!=0){
			throw new ErrorOnPageException("Valid To Date Calculate Not Correct",0+"",String.valueOf(mins));
		}
	}
	...
	public void wrapParameters(Object[] param) {
		...
		privilege.code = "ND2";
		privilege.name = "CalculateValidToDate_2";
		privilege.purchasingName = "ND2-CalculateValidToDate_2";
