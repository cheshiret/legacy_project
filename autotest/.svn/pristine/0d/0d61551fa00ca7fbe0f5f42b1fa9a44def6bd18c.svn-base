 ...
 * @author QA
 */
public class ServiceAndAmenitiesReport extends ResourceManagerTestCase{
	/**
	 * Script Name   : <b>RM_rptServiceAndAmenitiesReport</b>
	 * Generated     : <b>Jul 23, 2009 2:49:07 AM</b>
	 * Description   : Functional Test Script
	 ...
	 * test this report by run Park Profile Report-Section A - Services and Amenities
	 */
	...
	public void wrapParameters(Object[] param) {
		...
		rd.facilityID = "CROFT";
		rd.reportSection="Section A - Services and Amenities";
