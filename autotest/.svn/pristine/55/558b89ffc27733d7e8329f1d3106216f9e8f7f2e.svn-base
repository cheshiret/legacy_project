 ...
 *              5. verify message
 * @LinkSetUp:d_hf_add_privilege_prd:id=2790
 *            d_hf_add_cust_profile:id=3080
 * @SPEC:Reactivate Privilege - "Customer Demographic" rule violation [TC:004619] step6
 * @Task#:Auto-2134
 * 
 * @author Vivian
 * @Date  Apr 9, 2014
 */
public class Reactivate_CustDemoAgeOnTheParaDate_Most extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		privilege.code = "RP7";
		privilege.name = "ReactivatePriOrd07";
		...
		cust.identifier.identifierNum="ReactivePri05";
