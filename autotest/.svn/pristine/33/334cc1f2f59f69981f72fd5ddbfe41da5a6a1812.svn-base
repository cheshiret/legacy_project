...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.RestrictEntranceRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_RestrictEntrance extends SetupCase {
	...
	public void executeSetup() {
		new RestrictEntranceRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_restrict_entrance";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Restrict Entrance");//IMPORTANT
		...
		//Restrict Entrance specific attributes
