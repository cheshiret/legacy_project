...
/**
 * @Description: This case was designed as a boundary case for creating and activating site use fee schedules, to cover Defect-34432.
 * @Preconditions: 
 * @SPEC:
 * @Task#: Auto-1051
 * 
 ...
 * @Date  May 14, 2012
 */
public class SiteUseFee extends FinanceManagerTestCase {
	...
	public void execute() {
		...
		schedule.startInv = DateFunctions.getDateAfterGivenDay(
				schedule.startInv, 3);
		schedule.endInv = DateFunctions.getDateAfterGivenDay(
				schedule.endInv, 4);
