...
/**
 * 
 * @Description: verify adding POS Supplier on Agency level successfully
 * @Preconditions: need 'AddPOSSupplier' feature assigned,
 * 							and, role-location - '' assigned
 ...
 * @Date  Jul 24, 2012
 */
public class AddOnAgencyLevel extends InventoryManagerTestCase {
