 ...
 * @author QA
 */
public class POSProductSoldDetailReport extends ResourceManagerTestCase {
	/**
	 * Script Name : <b>RM_rptPOSProductSoldDetailReport</b> Generated : <b>Jul
	 * 22, 2009 8:33:37 AM</b> Description : Functional Test Script Original
