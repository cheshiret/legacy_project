 ...
 * Search customer from home page top menu
 * @Preconditions:
 * @SPEC:TC:032138
 * @Task#:AUTO-1324
 * 
...
public class IsPopulatedWithSearchValue_TopMenu extends LicenseManagerTestCase{
	...
	public void execute() {
		...
		//go to customer search page from home page top menu
	...
	public void wrapParameters(Object[] param) {
		...
		cust.identifier.identifierNum = "124356";
		cust.lName = "Auto";
		cust.fName = "Test";
		cust.mName = "Qa";
		cust.businessName = "QA Test";
		cust.dateOfBirth = "19870102";
		cust.hPhone = "8057856999";
