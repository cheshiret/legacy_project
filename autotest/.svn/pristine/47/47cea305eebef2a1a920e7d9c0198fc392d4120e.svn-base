 ...
 * @author QA
 */
public class UpdateUserAccount_NM extends WebTestCase
{
	/**
	 * Script Name   : <b>UpdateUserAccount_NM</b>
	 * Generated     : <b>Apr 22, 2010 4:32:32 AM</b>
	 * Description   : Functional Test Script
	...
	public void execute() {
		...
		//update email
		String newEmail = web.generateNewWebEmail("nm", env);
	...
	public void wrapParameters(Object[] param) {
		...
		String email = web.generateNewWebEmail("nm", env); //for private lable
