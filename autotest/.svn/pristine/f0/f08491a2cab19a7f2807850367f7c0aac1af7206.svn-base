 ...
 * @author Ssong
 */
public class SiteAttributeReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>SiteAttributeReportScheduler</b>
	 * Generated     : <b>Mar 5, 2010 1:05:48 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.reportName = "Site Attribute Report";
		rd.reportFormat = "XLS";
