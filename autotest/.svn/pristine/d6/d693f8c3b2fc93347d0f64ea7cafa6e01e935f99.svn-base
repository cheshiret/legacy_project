...
public class VerifySalesLocationCallCenter extends ResourceManagerTestCase{
	...
	public void execute() {
		...
		rptCriteriaPg.selectSalesChannel("Call Center");
		rptCriteriaPg.waitLoading();
		rm.VerifyReportSelectionCriteria("SalesChannel", salesChannel, "Call Center", salesChannel.get(0));
		
		//Verify the section of "Sales Location".
		rm.VerifyReportSelectionCriteria("SalesLocation", salesLocation, "All", "All");
