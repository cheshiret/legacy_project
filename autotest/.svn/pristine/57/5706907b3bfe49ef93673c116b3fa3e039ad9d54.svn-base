 ...
 * @author Ssong
 */
public class RecipientDistributionSummaryReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>RecipientDistributionSummaryReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 3:43:40 AM</b>
	 * Description   : Functional Test Script
