 ...
 * @Date  Mar 7, 2012
 */
public class AtLeastParamAgeOnParamDate2 extends LicenseManagerTestCase {
	...
	public void wrapParameters(Object[] param){
		...
		cust.fName = "QA-TransferRule29";
		cust.lName = "TEST-TransferRule29";//IMPORTANT: this customer's age must be older than 20
		...
		toCust.fName = "QA-TransferRule229";
		toCust.lName = "TEST-TransferRule229";//IMPORTANT: this customer's age must be younger than 20 and older than 10.
