...
/**
 * 1. User has no 'CreateModify... and 'Modify... permission
 * 2. User has no 'Create Change Request... permission
 */
public class NullModeDisplay extends InventoryManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		role_1.feature = "Create%"; //Include "Creat%ChangeRequest%";
