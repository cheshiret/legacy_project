 ...
 *               There has one season with Dock "All" and Slip type specific 
 ...
 * @Date  Mar 11, 2013
 */
public class Add_SchdWithAllDockSpecificSlip extends
	...
	public void execute() {
		...
		this.verifyProductListDisplay(season.prd_num[1], season.m_Loop , true);
	...
	public void wrapParameters(Object[] param) {
		...
		season.m_StartDate = DateFunctions.getDateAfterToday(2040);
		season.m_EndDate = DateFunctions.getDateAfterToday(2041);
		season.m_Loop = "All";
		season.m_SiteType = "Full attributes";
		season.m_DisplayName = "AddSeasonSlipsProductListAS";
