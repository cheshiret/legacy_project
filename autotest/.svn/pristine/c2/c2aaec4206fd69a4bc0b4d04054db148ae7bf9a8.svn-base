 ...
 * @Preconditions:discount info: Percent, per stay
 * @LinkSetUp: d_fin_add_discount:id=1510
 ...
 * @Date  May 12, 2014
 */
public class Percent_PerStay_OrdEndDate_MinUnit extends FinanceManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		disSchedule.discountName = "Percent_PerStay_OrdEndDate_MinUnit";
		disSchedule.rateType = "Percent";
