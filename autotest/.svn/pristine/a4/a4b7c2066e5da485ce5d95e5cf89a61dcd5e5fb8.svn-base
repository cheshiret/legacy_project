 ...
 * @Date  Mar 12, 2013
 */
public class Add_SchdWithSpecificDockAllSlip extends
InventoryManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		season.m_StartDate = DateFunctions.getDateAfterToday(2046);
		season.m_EndDate = DateFunctions.getDateAfterToday(2047);
		season.m_Loop = "AutoDock";
		season.m_SiteType = "All";
		season.m_DisplayName = "AddSeasonSlipsProductListSA";
