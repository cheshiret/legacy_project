 ...
 *                (d_hf_add_cust_profile, ID: 1920, 1930)
 ...
 * @Date  Mar 12, 2012
 */
public class AtMostParamAgeOnValidDateOfPrivilege2 extends LicenseManagerTestCase {
	...
	public void execute(){
		...
		// 1.update DOB of transfer to customer, will not violate business rule
		this.updateDOBForCust(cust, 1);//Make the customer's age is one day before 21 years old
		this.updateDOBForCust(toCust, 1);//Make the customer's age is one day before 21 years old
	...
	public void wrapParameters(Object[] param){
		...
		cust.fName = "QA-TransferRule24";
		cust.lName = "TEST-TransferRule24";// IMPORTANT this customer must be younger than 20.
		cust.identifier.identifierType = "MDWFP #";
		cust.residencyStatus = "Non Resident";
		cust.identifier.identifierNum = lm.getCustomerNumByCustName(cust.lName, cust.fName, schema);

		toCust.customerClass = OrmsConstants.INDIVIDUAL_CUSTOMER_CLASS;
		toCust.fName = "QA-TransferRule244";
		toCust.lName = "TEST-TransferRule244";// IMPORTANT this customer must be older than 20 and younger 40
