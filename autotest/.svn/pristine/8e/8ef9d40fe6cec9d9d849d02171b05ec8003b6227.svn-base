 ...
 * @author Ssong
 */
public class DailyAccruedRevenueReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>DailyAccruedRevenueReportScheduler</b>
	 * Generated     : <b>Mar 3, 2010 9:28:35 PM</b>
	 * Description   : Functional Test Script
