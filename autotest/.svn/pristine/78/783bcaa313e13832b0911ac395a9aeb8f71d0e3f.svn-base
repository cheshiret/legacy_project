 ...
 *               applies to Use Fee and the Rate Type is Percent; Display Discount is unchecked and Applies to Per Unit of Stay
 ...
 * 				d_fin_add_discount:id=1270(DISCOUNTNAME='AddSchedule_UseFee_Percent_PerUnitOfStay_UD')
 * @SPEC: [TC:049995] Add Discount Schedule_Use/Attribute Fee Per Unit of Stay_Flow
 * @Task#: Auto-1949
 * @author Phoebe
 * @Date  Dec 23, 2013
 */
public class UseFee_Percent_PerUnitOfStay_UD extends FinanceManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		//initialize Discount info
	  	discount.name = "AddSchedule_UseFee_Percent_PerUnitOfStay_UD"; //The discount should be added by set up script
