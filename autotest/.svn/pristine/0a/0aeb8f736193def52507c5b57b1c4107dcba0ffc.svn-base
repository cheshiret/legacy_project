...
/**
 * @Description:Update the details of a Slip Lottery in Inventory Manager with NC contract and Goes to admin Manager and check the Inventory Audit Logs of the actions.
 * @Preconditions:
 * @SPEC: [TC:043045]
 * @Task#:AUTO-1345
 * 
 ...
 * @Date  Dec 10, 2012
 */
public class EditLotteryPrd extends AdminManagerTestCase {
	...
	private String orderDescription = "Autotest";
	public void execute() {
		im.loginInventoryManager(login);
		lottery.id = im.addNewLottery(lottery);
		im.gotoLotteryDetailsPageFromLotterySearchPage(lottery);
		lottery.description = "AutoTest update";
		lottery.id = im.editLottery(lottery);
		im.logoutInvManager();
		
		lotteryLogs.actionDetails = "Lottery ID: " + lottery.id+", "+"Lottery Name: "+ lottery.name + " Description:"+ orderDescription +" --> "+lottery.description;//DEFECT-40687 won't fix
	...
	public void wrapParameters(Object[] param) {
	     ...
	     lottery.description = orderDescription;
	     ...
	     lotteryLogs.action = lotteryLogs.actionType + " Lottery Details";
