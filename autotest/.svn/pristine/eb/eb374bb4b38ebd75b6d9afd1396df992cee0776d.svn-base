...
/**
 * 
 * @Description: This case is used to verify adding report category successfully or not
 * @Preconditions:
 ...
 * @Date  Dec 29, 2011
 */
public class AddReportCategory extends LicenseManagerTestCase {
	...
	public void execute() {
		...
		//verify new added report category list and detail info
	...
	public void wrapParameters(Object[] param) {
		...
		reportCategory.description = "Basic_Add-"+DateFunctions.getCurrentTime();
	...
	private void verifyReportCategoryDetailInfo(PrivilegeReportCategory reportCategory) {
		...
		logger.info("Verify privielge Report Category detail info for reportCategory id=" + reportCategory.id);
