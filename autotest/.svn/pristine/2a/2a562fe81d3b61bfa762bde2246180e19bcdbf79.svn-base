 ...
 *               assign slip to first season with Slip Res Per Type as 'seasonal'
 *               assign slip to second season with Slip Res Per Type as 'seasonal' and got error message
 ...
 * @Date  Mar 05, 2013
 */
public class Add_OverlappingDateWithSeasonal extends
InventoryManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		season.m_StartDate = DateFunctions.getDateAfterToday(2035);
		season.m_EndDate = DateFunctions.getDateAfterToday(2038);
		season.m_Loop = "All";
		season.m_SiteType = "All";
		season.m_DisplayName = "AddSeasonSlipsTypeSame";
		season.prd_num = new String[] { "SFAS" };
		season.m_Slip_ResPeriodType = new String[] { SLIP_RESERVATION_TYPE_SEASONAL };
		season.m_Slip_Shared = new String[] { "No" };
		
		overlapseason.m_PrdCategory = "Slip";
		overlapseason.m_SeasonType = "Peak";
		overlapseason.m_StartDate = DateFunctions.getDateAfterToday(2036);
		overlapseason.m_EndDate = DateFunctions.getDateAfterToday(2039);
		overlapseason.m_Loop = "All";
		overlapseason.m_SiteType = "Full attributes";
		overlapseason.m_DisplayName = "AddSeasonSlipsTypeSeasonal";
		overlapseason.prd_num = new String[] { "SFAS" };
		overlapseason.m_Slip_ResPeriodType = new String[] { SLIP_RESERVATION_TYPE_SEASONAL };
		overlapseason.m_Slip_Shared = new String[] { "No" };
		message = "The following slip(s) are already assigned to other Season Schedules with overlapping dates: "
