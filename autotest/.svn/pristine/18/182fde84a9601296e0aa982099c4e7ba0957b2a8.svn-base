...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.TimeRestrictionBeforeChangeOfDatesAllowedRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_TimeRestrictionBeforeChangeOfDatesAllowed extends SetupCase {
	...
	public void executeSetup() {
		new TimeRestrictionBeforeChangeOfDatesAllowedRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_t_rest_bf_chg_dt_alo";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Time Restriction Before Change Of Dates Allowed");//IMPORTANT
		...
		//Time Restriction Before Change Of Dates Allowed specific attributes
