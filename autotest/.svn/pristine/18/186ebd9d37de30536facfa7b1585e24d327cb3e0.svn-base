 ...
 * @author QA
 */
public class UpdateUserAccount_UT extends WebTestCase
{
	/**
	 * Script Name   : <b>UpdateUserAccount_UT</b>
	 * Generated     : <b>Apr 22, 2010 4:32:19 AM</b>
	 * Description   : Functional Test Script
	...
	public void execute() {
		...
		//update email
		String newEmail = web.generateNewWebEmail("ut", env);
	...
	public void wrapParameters(Object[] param) {
		...
		String email = web.generateNewWebEmail("ut", env); //for private lable
