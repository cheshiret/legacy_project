...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaximumStockByRatioRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaximumStockByRatio extends SetupCase {
	...
	public void executeSetup() {
		new MaximumStockByRatioRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Stock by Ratio");//IMPORTANT
		...
		//Maximum Stock By Ratio specific attributes
		//TODO
	}
}
