...
/**
 * @Description:
 * 1: verify when select Camping & Lodging - Looking for: Cabins, the data populated in the campground details page is correct.
 * @Preconditions:
 ...
 * @Date  Nov 2, 2011
 */
public class CampingCabins extends RecgovTestCase {
