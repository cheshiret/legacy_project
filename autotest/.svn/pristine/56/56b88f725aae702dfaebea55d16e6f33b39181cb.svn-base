...
/**
 * @Description:
 * 1: verify when select Camping & Lodging - Looking for: Day use & Picnic areas, the data populated in the campground details page is correct.
 * @Preconditions:
 ...
 * @Date  Nov 2, 2011
 */
public class CampingDayUsePicnicAreas extends RecgovTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		bd.occupants = "2";
		bd.moreOptions = true;
		bd.electricHookupValue = "50 Amp (or more)";
		bd.waterFront = true;
		...
		bd2.loop = "Any Loop";
		bd2.arrivalDate = DateFunctions.getDateAfterToday(4);
		bd2.lengthOfStay = "2";
