 ...
 * @author Ssong
 */
public class RefundRequestReasonReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>RefundRequestReasonReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 3:51:19 AM</b>
	 * Description   : Functional Test Script
