...
public class AdvancedReservationWithNightlyRates_7 extends
	...
	public void wrapParameters(Object[] param) {
		...
		feeData.bookDate = "Sun May 9 2010";
		feeData.arriveDate = "Wed May 12 2010";
		feeData.departureDate = "Tue May 18 2010";
		feeData.nights.add("6");
		feeData.time.add("5/12/2010");
		String[] cond = { "vehRange", "2", "", "6", "5/12/2010" };
