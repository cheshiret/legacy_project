package com.activenetwork.qa.awo.testcases.regression.advanced.orms.order.license.products.privileges.pricing.viewpricinglist;
...
/**
 * 
 * @Description:This case is used to verify view privilege pricing list. 
...
public class VerifyBusinessRulesAndUI extends LicMgrViewProductPricingListTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		pricingInfo[3].purchaseType = "Duplicate";
		...
		pricingInfo[4].purchaseType = "Duplicate";
