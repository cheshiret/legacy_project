 ...
 *              3. add business rule "Customer must have parameter CERTIFICATION type on file in order to purchase"
 *              4. reactivate privilege order
 *              5. verify message
 * @LinkSetUp:d_hf_add_privilege_prd:id=2740
 *            d_hf_add_cust_profile:id=3030
 * @SPEC:Reactivate Privilege - "Education/Certification Enforcement" rule violation [TC:004621] step2
 * @Task#:Auto-2134
 * 
 * @author Vivian
 * @Date  Apr 9, 2014
 */
public class Reactivate_CertificationTypeCustomerRule extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		privilege.code = "RP2";
		privilege.name = "ReactivatePriOrd02";
