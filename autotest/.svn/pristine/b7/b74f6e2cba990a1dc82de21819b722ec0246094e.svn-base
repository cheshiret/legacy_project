...
public class MakeResWithOldCustomer_MD extends WebTestCase  {
	private Customer cust;
	private String contract = "MD"; //for creating schema name
	...
	public void wrapParameters(Object[] param) {
		...
		bd.siteID = "1143";
		bd.siteNo = DataBaseFunctions.getSiteNum(bd.siteID, schema); //"4 BLUEBIRD";
	}
}
