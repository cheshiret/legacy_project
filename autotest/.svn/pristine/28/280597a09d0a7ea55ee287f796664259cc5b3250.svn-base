 ...
 * that Change Request Item Status change from 'Submitted' to 'Rejected'
 */
public class VerifyChangeReqAndItemsInfo_SubmittedToRejected extends InventoryManagerTestCase{
