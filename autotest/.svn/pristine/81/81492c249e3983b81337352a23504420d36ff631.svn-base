...
/**
 * @Description: Reverse Registration from license manager, verify order cart info and order summary info 
 * @Preconditions: 
 ...
 * 
 */
public class OrderCartAndSummary_ReverseRegistration extends LicenseManagerTestCase{
