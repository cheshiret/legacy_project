 ...
 * @author Ssong
 */
public class RAFinanceSalesReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>RAFinanceSalesReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 3:16:49 AM</b>
	 * Description   : Functional Test Script
