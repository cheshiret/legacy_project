...
/**
 * use single schedule with nightly family rate (rate value is zero)
 * 
 * @author Sophia
 * 
 */
public class WalkinWithNightlyRates_1 extends InventoryManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		feeData.bookDate = "Mon Jan 11 2010";
		feeData.arriveDate = "Mon Jan 11 2010";
		feeData.departureDate = "Thu Jan 14 2010";
	...
	public void verifyAttributeFee(FeeValidationData feeData) {
		...
		// calculate rule
		BigDecimal amount = feeCal.calculateBaseFee(feeData, 0, true).get(0);
		...
		for (int i = 0; i < attributeFee.size(); i++) {
			sysAmount = attributeFee.get(i);
			compareAmount = compare.get(i);
