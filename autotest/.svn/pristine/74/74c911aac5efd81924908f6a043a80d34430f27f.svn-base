 ...
 * @author Ssong
 */
public class YieldManagementReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>YieldManagementReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 4:38:33 AM</b>
	 * Description   : Functional Test Script
