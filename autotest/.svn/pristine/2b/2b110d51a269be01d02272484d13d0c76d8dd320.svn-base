 ...
 * @Preconditions:discount info: flat, per stay
 * @LinkSetUp: d_fin_add_discount:id=1490
 ...
 * @Date  May 12, 2014
 */
public class Flat_PerStay_OrdEndDate_MinUnit extends FinanceManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		disSchedule.discountName = "Flat_PerStay_OrdEndDate_MinUnit";
		disSchedule.rateType = "Flat";
		disSchedule.unitType = "Per Stay";
	}
	...
	private void verifyOrderCreateEnddateAndMinimumUnitOfStayIsEixsting(boolean endDateIsExists,boolean minStayIsExists){
		...
		if(!result){
			throw new ErrorOnPageException("Order create end date and minimum unit of stay exists info not correct, please check.");
