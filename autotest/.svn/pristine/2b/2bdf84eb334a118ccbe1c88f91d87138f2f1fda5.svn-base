...
/**
 * @Description: Renewal registration from license manager, verify order cart info and order summary info 
 * @Preconditions: 
 ...
 * 
 */
public class OrderCart_RenRegistration extends LicenseManagerTestCase{
	...
	public void execute() {
		...
		registration.purchaseType = "Renewal";		
		...
		//verify click registration info link
	...
	public void wrapParameters(Object[] param) {
		...
		vehicle.type = "Boat";
		vehicle.hullIdSerialNum = "OrdCartRR"+DataBaseFunctions.getEmailSequence();
		...
		productItemInfo = "(" + licenseYear + ")" + vehicle.registration.product.replace(" - ", "-") + "(Renewal)";
