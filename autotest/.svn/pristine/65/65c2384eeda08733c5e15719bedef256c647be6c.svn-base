 ...
 *              1. create use fee schedule for Slip work flow
 *              2. go to admin manager to verify add use fee schedule audit log
 * @Preconditions:
 * @SPEC: Add Use Fee Schedule - Log [TC:049741]
 * @Task#:AUTO-1419
 * 
 * @author vzhang
 * @Date  Jan 8, 2013
...
public class AddUseFeeSchdAuditLogs_Slip extends AdminManagerTestCase{
	...
	public void execute() {
		...
		this.verifyAddUseFeeSchdAuditLog(feeLogs);
		am.logoutAdminMgr();		
	}
	...
	private void verifyAddUseFeeSchdAuditLog(AuditLogInfo expAudit){
		logger.info("Verify add use fee audit log info.");
