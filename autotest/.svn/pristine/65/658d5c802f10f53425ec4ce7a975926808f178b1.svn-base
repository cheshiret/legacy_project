 ...
 * @author Ssong
 */
public class DailyFacilityManagementDataReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>DailyFacilityManagementDataReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 8:53:07 PM</b>
	 * Description   : Functional Test Script
