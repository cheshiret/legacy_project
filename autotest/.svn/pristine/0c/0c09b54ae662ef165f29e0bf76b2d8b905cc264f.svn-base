 ...
 * @author Ssong
 */
public class CreditCardBatchSummaryReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>CreditCardBatchSummaryReportScheduler</b>
	 * Generated     : <b>Mar 3, 2010 9:07:14 PM</b>
	 * Description   : Functional Test Script
