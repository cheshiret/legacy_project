 ...
 * @author Ssong
 */
public class DiscountDetailReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>DiscountDetailReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 12:10:04 AM</b>
	 * Description   : Functional Test Script
  ...
  public void wrapParameters(Object[] param) {
	...
	rd.reportName = "Discount Detail Report";
	rd.reportFormat = "XLS";
