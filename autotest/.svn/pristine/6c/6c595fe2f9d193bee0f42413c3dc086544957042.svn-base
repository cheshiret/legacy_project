 ...
 * @Date  Oct 31, 2011
 */
public class LookingForAndEntrance2 extends RecgovTestCase{
	...
	private void verifyExpectedPage(){
		...
		searchResult.clickFirstParkPermitTypes(2);
	...
	private void verifyLookingForAndEntranceValue(){
		...
		permitSearchPanel.verifyPermitTypeValue(permitTypes[2]);
