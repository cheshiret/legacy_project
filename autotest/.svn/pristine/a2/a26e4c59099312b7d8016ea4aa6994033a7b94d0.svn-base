...
public class WalkinWithoutScheduleForSomeNights_4 extends
	...
	public void wrapParameters(Object[] param) {
		...
		feeData.bookDate = "Sat Aug 07 2010";
		feeData.arriveDate = "Sat Aug 07 2010";
		feeData.departureDate = "Wed Aug 18 2010";
		feeData.nights.add("1");
		feeData.nights.add("4");
		feeData.time.add("8/07/2010");
		feeData.time.add("8/14/2010");
	...
	public void verifyAttributeFee(FeeValidationData feeData) {
		...
		BigDecimal amount1 = feeCal.calculateBaseFee(feeData, 0, false).get(1);
		String fee = amount.toString() + feeData.schedules.get(0) + "Weekly";
		String fee1 = amount1.toString() + feeData.schedules.get(1)
				+ "Daily/Nightly";
