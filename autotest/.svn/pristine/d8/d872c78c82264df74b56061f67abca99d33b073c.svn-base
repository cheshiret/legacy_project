 ...
 * @author Ssong
 */
public class ServiceAndAmenitiesReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>ServiceAndAmenitiesReportScheduler</b>
	 * Generated     : <b>Mar 5, 2010 1:03:28 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.reportName = "Service and Amenities Report";
		rd.reportFormat = "PDF";
