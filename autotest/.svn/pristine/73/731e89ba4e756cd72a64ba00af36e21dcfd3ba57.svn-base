...
/**
 * @Description:Rule Name: Customer must be a NON-RESIDENT in order to purchase this license
 ...
 *                3.For transfer to customer, must have Identifier of SSN.
 ...
 * @Date  Mar 7, 2012
 */
public class NonResidentCustomer extends LicenseManagerTestCase {
...
//		this.verifyMessage(page);
		...
		// 4.transfer again, should succeed
	...
	public void wrapParameters(Object[] param){
		...
		cust.residencyStatus = "Non Resident";// IMPPRTANT:Don't change this data!
		cust.identifier.identifierNum = lm.getCustomerNumByCustName(cust.lName, cust.fName, schema);
		//cust.identifier.identifierNum ="814617882";

		privilege.code = "996";
		privilege.purchasingName = "996-TransferNonResCust";
		...
		toCust.fName = "QA-TransferRule22";
		toCust.lName = "TEST-TransferRule22";
		toCust.residencyStatus = "Resident";// IMPPRTANT:Verify point, don't change this data.
		toCust.identifier.identifierType = "Social Security Number";
		toCust.identifier.identifierNum = "123654789";
