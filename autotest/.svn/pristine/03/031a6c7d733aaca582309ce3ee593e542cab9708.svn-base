 ...
 * @author Ssong
 */
public class CreditCardBatchDetailReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>CreditCardBatchDetailReportScheduler</b>
	 * Generated     : <b>Mar 3, 2010 9:04:27 PM</b>
	 * Description   : Functional Test Script
