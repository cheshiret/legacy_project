...
public class BookSiteBlockWebSalesChannel extends RATestCase {
	private String ruleName = "Maximum Window";
	private String theLastestArrivalDate;
	
	/**
	 * The Maximum Window Type=block, Length=10, Unit=month, Block Release Length=1, Block Release Unit=month, Block Release Of Month=1st
	 */
	public void execute() {
		...
		theLastestArrivalDate = DateFunctions.getDateAfterGivenMonth(
						DateFunctions.combineStringToDate(yearOfToday, monthOfToday, "1"), 11);
