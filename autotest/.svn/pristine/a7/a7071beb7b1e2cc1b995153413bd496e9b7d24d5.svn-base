 ...
 * @author Ssong
 */
public class QuotaAvailabilityReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>QuotaAvailabilityReportScheduler</b>
	 * Generated     : <b>Mar 5, 2010 12:41:39 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		String facilityID="75533";
		
		//initialize report data
		rd.group = "Operational Reports";
		rd.reportName = "Quota Availability Report";
		rd.facilityLocID = DataBaseFunctions.getFacilityName(facilityID, schema);
