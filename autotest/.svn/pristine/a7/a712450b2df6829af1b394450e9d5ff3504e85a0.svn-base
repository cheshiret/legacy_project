 ...
 * @author vzhao
 */
public class CancelPLResFromRA_ID extends WebTestCase
{
	/**
	 * Script Name   : <b>CancelPLResFromRA_ID</b>
	 * Generated     : <b>Apr 23, 2010 1:27:46 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		plUrl = TestProperty.getProperty(env + ".web.id.url");
