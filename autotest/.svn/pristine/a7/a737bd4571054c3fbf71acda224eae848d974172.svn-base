...
public class NewOrder_RuleAttrSetTrue_Privielge extends LicenseManagerTestCase{
	...
	public void execute() {
		...
		//payment amount less than minimum payment
		//(minimum payment is equal to full payment because privilege must full payment is required)
	...
	public void wrapParameters(Object[] param) {
		...
		cust.dateOfBirth = "19880629";
		cust.identifier.identifierType = "Green Card";
		cust.identifier.identifierNum = "111197";
		cust.identifier.country = "Canada";
		cust.residencyStatus = "Non Resident";
		cust.fName="TEST-Basic97";
		cust.lName="QA-Basic97";
