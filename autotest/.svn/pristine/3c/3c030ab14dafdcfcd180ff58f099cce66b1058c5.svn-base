...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaximumStayRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaximumStay extends SetupCase {
	...
	public void executeSetup() {
		new MaximumStayRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Stay");//IMPORTANT
		...
		//Maximum Stay specific attributes
