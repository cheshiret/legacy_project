...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaxNumOfEntriesPerListRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaxNumOfEntriesPerList extends SetupCase {
	...
	public void executeSetup() {
		new MaxNumOfEntriesPerListRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Number of Entries Per List");//IMPORTANT
		...
		//Maximum Number of Entries Per List specific attributes
		ruleData.maximumNumberOfEntries = Integer.parseInt(datasFromDB.get("MaximumNumberOfEntries"));//TODO
	}
}
