 ...
 * @author vzhao
 */
public class UpdateUserAccount_KY extends WebTestCase
{
	/**
	 * Script Name   : <b>UpdateUserAccount_KY</b>
	 * Generated     : <b>Nov 26, 2009 8:44:18 PM</b>
	 * Description   : Functional Test Script
	...
	public void execute() {
		...
		//update email
		String newEmail = web.generateNewWebEmail("ky", env);
	...
	public void wrapParameters(Object[] param) {
		...
		String email = web.generateNewWebEmail("ky", env); //for private lable
