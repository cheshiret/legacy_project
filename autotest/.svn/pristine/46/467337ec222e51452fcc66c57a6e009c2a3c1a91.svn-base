 ...
 * Please notice that if it is a new year, the quota and date period is set up in last year, the case will failed for they will not show as current year!
 * @Preconditions:
 ...
 * @Date Sep 20, 2012
 */
public class AddHunt extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		//hunt info
		hunt.setSpecie("Pet");
		hunt.setHuntCode("AddHunt");
		hunt.setDescription("ForJustAddHuntCase");
