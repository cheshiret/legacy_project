 ...
 * @Date  Sep 29, 2011
 */
public class LicMgrSupplyAgentAssignmentsPage extends LicMgrSupplyProductDetailsPage implements ILicMgrProductAgentAssignmentsPage{

	private static LicMgrSupplyAgentAssignmentsPage _instance=null;
	
	public static LicMgrSupplyAgentAssignmentsPage getInstance(){
		if(_instance==null){
			_instance=new LicMgrSupplyAgentAssignmentsPage();
		}
		return _instance;
	}
	...
	public boolean exists() {
		return browser.checkHtmlObjectExists(".class", "Html.DIV", ".id", "LocationClassOverviewTable" )&&super.exists();
	}
