...
public class ScriptsLauncher implements ActionListener {
	...
	JCheckBox listedInFile = new JCheckBox("Only cases listed in file", false);
	...
	JCheckBox qa3Selection = new JCheckBox("QA3", true);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (source == runNow) {    //click runNow Button
			...
			String logName=OrmsConstants.TIMESTAMP;
			testCasePath=testSuitePath.getText();
