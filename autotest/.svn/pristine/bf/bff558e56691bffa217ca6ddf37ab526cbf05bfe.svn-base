 ...
 *                applies to Transaction Fee and the Rate Type is Percent; Behavior is Automatic Discount is unchecked, the others are checked
 ...
 * 				d_fin_add_discount:id=1210(DISCOUNTNAME='AddSchedule_TransFee_Percent_OnlyAutoUnchecked')
 * @SPEC:[TC:049989]Add Discount Schedule_Transaction Fee_Flow 
 * @Task#: Auto-1949
 * @author Phoebe
 * @Date  Dec 23, 2013
 */
public class TransactionFee_Percent_JustAutoUnchecked extends FinanceManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		//initialize Discount info
	  	discount.name = "AddSchedule_TransFee_Percent_OnlyAutoUnchecked"; //The discount should be added by set up script
