 ...
 * 				d_fin_add_discount:id=1230(DISCOUNTNAME='AddSchedule_UseFee_Override_DisplayUnchecked')
 * @SPEC: [TC:049992] Add Discount Schedule_Override Use/Attribute Fee_Flow
 * @Task#: Auto-1949
 * @author Phoebe
 * @Date  Dec 23, 2013
 */
public class UseFee_Override_DisplayUnchecked extends FinanceManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		//initialize Discount info
	  	discount.name = "AddSchedule_UseFee_Override_DisplayUnchecked"; //The discount should be added by set up script
