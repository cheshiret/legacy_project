...
/**
 * 
 * @Description: verify the system retrieves vehicle products which are satisfied conditions list for Original titling
 ...
 * @Date  Jun 27, 2012
 */
public class GetListForTitling_Original extends LicenseManagerTestCase{
	...
	private String locationClass, adminLocation, salesLocation;
	...
	public void execute() {
		...
		lm.titleVehicleToTitleProductSelectionWidget(boat);
		//verify needed to title vehicle product really exist in the titling list
		LicMgrVehicleRegistrationWidget.getInstance().
				verifyProductExistingInList(boat.title.product, boat.title.purchaseType, true);
		//continue to finish the titling process
	...
	public void wrapParameters(Object[] param) {
		...
		titleVehicleRTI.setPrdName("OriginalTitleVehicleBoat");
		...
		titlePricing.vendorFee = "5";
		titlePricing.stateTransFee = "4";
		titlePricing.stateFee = "3";
		titlePricing.transFee = "2";
