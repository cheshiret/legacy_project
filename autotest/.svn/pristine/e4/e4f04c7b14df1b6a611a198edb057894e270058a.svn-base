...
/**
 * @Description:
 * 1: verify when select Camping & Lodging - Looking for: Lookouts, the data populated in the campground details page is correct.
 * @Preconditions:
 ...
 * @Date  Nov 2, 2011
 */
public class CampingLookouts extends RecgovTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		bd2.lookFor = "Lookouts";
		bd2.occupants = "2";
		bd2.moreOptions = true;
		bd2.electricHookupValue = "15 Amp (or more)";
		bd2.waterFront = true;
		...
		bd.moreOptions = true;
		bd.electricHookupValue = "20 Amp (or more)";
