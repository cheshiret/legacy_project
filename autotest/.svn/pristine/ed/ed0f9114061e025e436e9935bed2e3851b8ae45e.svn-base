 ...
 * @author Ssong
 */
public class RecipientDistributionDetailReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>RecipientDistributionDetailReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 3:22:24 AM</b>
	 * Description   : Functional Test Script
