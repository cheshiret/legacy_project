 ...
 * @author Ssong
 */
public class VoucherBalanceReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>VoucherBalanceReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 4:33:39 AM</b>
	 * Description   : Functional Test Script
