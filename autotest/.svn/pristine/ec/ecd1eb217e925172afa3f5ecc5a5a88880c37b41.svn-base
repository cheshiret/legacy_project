...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaxNumOfPermitsPerPeriodNonProfitOrgRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaxNumOfPermitsPerPeriodNonProfitOrg extends SetupCase {
	...
	public void executeSetup() {
		new MaxNumOfPermitsPerPeriodNonProfitOrgRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_max_n_pmit_p_prd_org";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Number of Permits Per Period/Non Profit Organization");//IMPORTANT
		...
		//Maximum Number of Permits Per Period/Non Profit Organization specific attributes
		ruleData.maximumNumberOfOrdersPerPeriod = datasFromDB.get("MAXNUMOFORDSPERPERIOD");
