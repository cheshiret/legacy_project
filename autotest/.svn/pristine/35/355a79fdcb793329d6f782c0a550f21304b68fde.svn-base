 ...
 * @Date  Jan 08, 2013
 */
public class Cancel_Add_List extends FinanceManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		//initialize login finance manager loginInfo
	  	...
	  	//initialize Tax info
	  	tax.taxName = "cancel_list" + DateFunctions.getCurrentTime();
	  	tax.taxCode = "CancelList";
	  	tax.taxDescription = "add tax schedule List and cancel";
	 	...
	 	schedule.productCategory = "List"; //This is the test point, can not be changed
	  	...
	  	schedule.startDate = "2010-2-1";
	  	schedule.endDate = "2010-2-31";
