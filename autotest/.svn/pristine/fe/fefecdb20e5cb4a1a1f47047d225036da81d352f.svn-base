 ...
 * @author Ssong
 */
public class SevenDayCampersReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>SevenDayCampersReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 4:53:06 AM</b>
	 * Description   : Functional Test Script
