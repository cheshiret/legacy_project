 ...
 * @Date  Mar 7, 2012
 */
public class AtMostParameterAgeOnPurchasePrivilegeDate extends LicenseManagerTestCase {
	...
	public void execute(){
		...
		this.updateDOBForCust(toCust, 0);//Make the customer's age is one day before 21 years old
	...
	public void wrapParameters(Object[] param){
		...
		cust.fName = "QA-TransferRule4";
		cust.lName = "TEST-TransferRule4";// IMPORTANT this customer must be younger than 20.
		...
		toCust.fName = "QA-TransferRule44";
		toCust.lName = "TEST-TransferRule44";// IMPORTANT this customer must be older than 20 and younger than 40
		...
		ruleName = "Customer must be AT MOST parameter age on the date of Privilege purchase";
