 ...
 * @author Ssong
 */
public class TicketSalesStatisticsReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>TicketSalesStatisticsReportScheduler</b>
	 * Generated     : <b>Mar 5, 2010 1:32:43 AM</b>
	 * Description   : Functional Test Script
