...
/**
 * 
 * @Description: This case is used to verify whether add a display category successfully or not
 * @Preconditions:
 * @SPEC: <<Add Privilege Display Category.doc>>
 * @Task#: AUTO-842
 * 
 * @author qchen
 * @Date  Dec 28, 2011
 */
public class AddDisplayCategory extends LicenseManagerTestCase {
	...
	public void execute() {
		...
		//verify the new added display category list and detail info
...
//		TimeZone tz = DataBaseFunctions.getContractTimeZone(schema);
		...
		displayCategory.description = "Basic_Add-"+DateFunctions.getCurrentTime();
