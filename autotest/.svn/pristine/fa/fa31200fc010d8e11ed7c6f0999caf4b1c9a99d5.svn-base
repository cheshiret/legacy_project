 ...
 * @author Ssong
 */
public class ParkEventReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>ParkEventReportScheduler</b>
	 * Generated     : <b>Mar 5, 2010 12:18:04 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.reportName = "Park Event Report";
		rd.reportFormat = "PDF";
