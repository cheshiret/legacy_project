...
/**
 * 
 * @Description:(P) For revoked (from award status) lottery application with Group Application type, 
 * check lottery attributes and entered hunts info in account overview, order history and lottery application page
 * @Preconditions:
 * @LinkSetUp:
 * d_web_hf_signupaccount:id=1410 --RCMP #|1R9Y4x4196
 ...
 * d_hf_add_hunt:id=880 --LAH13
 * d_hf_add_hunt_license_year:id=800
 * d_hf_assign_priv_to_hunt:id=580
 * d_hf_add_hunt_quota:id=190
 * d_hf_add_hunt_location:id=70
 * d_hf_add_weapon:id=50
 * d_hf_add_lottery_prd:id=320--WLL
 * d_hf_add_lottery_license_year:id=230
 * d_hf_add_lottery_quantity_control:id=230
 * d_hf_assign_lottery_to_store:id=230
 * d_hf_assi_hunts_to_lottery:id=250
 * d_hf_add_lottery_execution_config:id=210 --WebLottery12Config
 * d_hf_add_lottery_schedule:id=150 --WebLottery12Processing
 ...
 * @Date  Mar 9, 2014
 */
public class Revoked_GroupLeader extends HFSKLotteryApplicationTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		cus.identifier.identifierNum = "1R9Y4x4196";
		...
		//lottery info
		lottery.setCode("WLL");
		lottery.setDescription("WebLottery12");
		...
		schedule.setExecutionConfig("WebLottery12Config");
		schedule.setLicenseYear(quota.getLicenseYear()); 
		schedule.setDescription("WebLottery12Processing");
