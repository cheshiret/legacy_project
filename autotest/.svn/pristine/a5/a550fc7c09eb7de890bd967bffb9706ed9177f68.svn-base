...
public class LotteryApplicationsPageTrigger extends WebTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		bd.arrivalDate = this.getArrivalDateForLottery();// hard code the arrival date for lottery inventory date
		bd.lengthOfStay = "4";
	}
