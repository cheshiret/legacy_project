...
/**
 * @Description:This case cover motor in XLS format from resource manager
 * @Preconditions:
...
public class VehicleRegistrationRenewalReport extends ResourceManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		rd.vehicleType = "Motor";
		rd.vehicleAttribute = "Motor Fuel";
		rd.vehicleAttrOptions = new String[]{"Gasoline","Electric"};
