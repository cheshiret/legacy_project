 ...
 * @author Ssong
 */
public class CustomerBalanceReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>CustomerBalanceReportScheduler</b>
	 * Generated     : <b>Mar 3, 2010 9:18:27 PM</b>
	 * Description   : Functional Test Script
