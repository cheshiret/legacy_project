...
/**
 * 
 * @ScriptName LicMgrPrivilegeQuestionPage.java
 * @author szhou
 * @Date May 19, 2011
 */
public class LicMgrPrivilegeQuestionPage extends LicMgrPrivilegeProductDetailsPage implements ILicMgrProductQuestionPage{

	private static LicMgrPrivilegeQuestionPage instance = null;

	private LicMgrPrivilegeQuestionPage() {
	}

	public static LicMgrPrivilegeQuestionPage getInstance() {
		if (instance == null) {
			instance = new LicMgrPrivilegeQuestionPage();
		}
		return instance;
	}
	...
	public void unSelectShowCurrentOnly(){
		browser.unSelectCheckBox(".id", 
				new RegularExpression("^SearchPrdQuestionAssignmentCriteria-\\d+\\.showCurrent",false));
		ajax.waitLoading();
	}
	
	public void selectStatus(String status){
		browser.selectDropdownList(".id", 
				new RegularExpression("^SearchPrdQuestionAssignmentCriteria-\\d+\\.status",false), status);
	}
	...
	public void setDisplayText(String displayText){
		browser.setTextField(".id", 
				new RegularExpression("^SearchPrdQuestionAssignmentCriteria-\\d+\\.displayText",false), displayText);
	}
	
	public void selectLocationClass(String locationClass){
		browser.selectDropdownList(".id", 
				new RegularExpression("^SearchPrdQuestionAssignmentCriteria-\\d+\\.locationClassID",false), locationClass);
	}
	...
	public void verifySearchResultMatchCriteria(String colName, String colValue) {
		this.verifySearchResultMatchCriteria(".id", "product_question_assignment", colName, colValue);
	}
...
//		}
	...
	/**
	 * Click privilege question assignment id to go to question assignment detail widget
	 * @param id
	 */
