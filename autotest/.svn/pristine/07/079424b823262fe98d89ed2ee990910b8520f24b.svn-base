 ...
 * @author Ssong
 */
public class SCParkRevenueDetailReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>SCParkRevenueDetailReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 4:02:57 AM</b>
	 * Description   : Functional Test Script
