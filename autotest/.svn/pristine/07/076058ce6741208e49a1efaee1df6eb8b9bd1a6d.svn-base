 ...
 * @author Ssong
 */
public class UsagebySiteTypeReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>UsagebySiteTypeReportScheduler</b>
	 * Generated     : <b>Mar 5, 2010 1:42:08 AM</b>
	 * Description   : Functional Test Script
	...
	public void wrapParameters(Object[] param) {
		...
		rd.reportName = "Usage by Site Type Report";
		rd.reportFormat = "XLS";
