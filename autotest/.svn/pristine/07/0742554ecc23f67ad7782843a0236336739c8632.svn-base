 ...
 * @author Ssong
 */
public class RevenueDistributionSummaryReportScheduler extends ResourceManagerTestCase
{
	/**
	 * Script Name   : <b>RevenueDistributionSummaryReportScheduler</b>
	 * Generated     : <b>Mar 4, 2010 3:57:46 AM</b>
	 * Description   : Functional Test Script
