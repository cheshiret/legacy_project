...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.StayBeyondMaximumWindowRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_StayBeyondMaximumWindow extends SetupCase {
	...
	public void executeSetup() {
		new StayBeyondMaximumWindowRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_stay_beyd_maxi_wind";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Stay Beyond Maximum Window");//IMPORTANT
		...
		//Stay Beyond Maximum Window specific attributes
