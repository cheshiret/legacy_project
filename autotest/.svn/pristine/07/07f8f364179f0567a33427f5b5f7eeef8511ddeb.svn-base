...
public class PerPersonRate_1 extends WebTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		bd.entrance = "70 North Fowl Lake (op)";
		...
		unit.put(PersonTypeCode.INTERAGENCY_SENIOR_PASS, "3");
		feeData.units.add(unit);
		feeData.personType.add(PersonTypeCode.ADULT);
		feeData.personType.add(PersonTypeCode.INTERAGENCY_SENIOR_PASS);
