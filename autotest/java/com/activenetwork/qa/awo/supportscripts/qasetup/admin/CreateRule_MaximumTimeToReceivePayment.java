...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaximumTimeToReceivePaymentRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaximumTimeToReceivePayment extends SetupCase {
	...
	public void executeSetup() {
		new MaximumTimeToReceivePaymentRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_max_t_to_recv_pmt";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Time To Receive Payment");//IMPORTANT
		...
		//Maximum Time To Receive Payment specific attributes
