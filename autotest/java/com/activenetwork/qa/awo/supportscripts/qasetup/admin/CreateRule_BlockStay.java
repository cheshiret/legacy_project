...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.BlockStayRuleFunction;
 ...
 * @Date  Jul 18, 2013
 */
public class CreateRule_BlockStay extends SetupCase {
	...
	public void executeSetup() {
		new BlockStayRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_block_stay";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Block Stay");
		...
		//Block Stay specific attributes
		ruleData.transactionOccurrence = datasFromDB.get("TransactionOccurrence");
		ruleData.transactionOccurrenceDays = datasFromDB.get("TransactionOccurrenceDays");
		ruleData.blockStay = datasFromDB.get("BlockStay");
		ruleData.holidayblockstay = datasFromDB.get("HolidayBlockStay");
		ruleData.allowAvailabilityException = datasFromDB.get("AllowavailAbilityException");
		ruleData.allowStayLengthException = datasFromDB.get("AllowStayLengthException");
	}
}
