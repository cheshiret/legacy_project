...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaximumStayPerPeriodRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaximumStayPerPeriod extends SetupCase {
	...
	public void executeSetup() {
		new MaximumStayPerPeriodRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_max_stay_per_period";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Stay Per Period");//IMPORTANT
		...
		//Maximum Stay Per Period specific attributes
		ruleData.maximumStayPerPeriod = datasFromDB.get("MAXSTAYPERTIMEPERIODLENGTH");
