...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaximumTotalStayRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaximumTotalStay extends SetupCase {
	private LoginInfo login;
	private RuleDataInfo ruleData;
	@Override
	public void executeSetup() {
		new MaximumTotalStayRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_maximum_total_stay";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Total Stay");//IMPORTANT
		...
		//Maximum Total Stay specific attributes
