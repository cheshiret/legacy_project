...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaximumWatercraftsRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaximumWatercrafts extends SetupCase {
	private LoginInfo login;
	private RuleDataInfo ruleData;
	@Override
	public void executeSetup() {
		new MaximumWatercraftsRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "";//TODO not used so far
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Watercrafts");//IMPORTANT
		...
		//Maximum WaterCraft specific attributes
