...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaxNumOfOrdersWithinStayPeriodRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaxNumOfOrdersWithinStayPeriod extends SetupCase {
	...
	public void executeSetup() {
		new MaxNumOfOrdersWithinStayPeriodRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_max_n_ord_in_st_perd";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Number Of Orders Within Stay Period");//IMPORTANT
		...
		//Maximum Number Of Orders Within Stay Period specific attributes
		ruleData.maximumNumberOfOrdersWithinStayPeriod = datasFromDB.get("MAXNUMORDWITHINSTAYPERIOD");
