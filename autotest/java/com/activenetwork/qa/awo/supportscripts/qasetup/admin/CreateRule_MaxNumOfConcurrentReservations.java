...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MaxNumOfConcurrentReservationsRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MaxNumOfConcurrentReservations extends SetupCase {
	...
	public void executeSetup() {
		new MaxNumOfConcurrentReservationsRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_max_n_con_res";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Maximum Number Of Concurrent Reservations");//IMPORTANT
		...
		//Maximum Number Of Concurrent Reservations specific attributes
		ruleData.maximumNumberOfConcurrentReservations = datasFromDB.get("MAXNUMCONRES");
