...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.AutomaticCancellationRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_AutomaticCancellation extends SetupCase {
	...
	public void executeSetup() {
		new AutomaticCancellationRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_automatic_cancellation";//TODO: no support table
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		new RuleDataInfo("Automatic Cancellation");
		...
		//Automatic Cancellation specific attributes
		//TODO
	}
}
