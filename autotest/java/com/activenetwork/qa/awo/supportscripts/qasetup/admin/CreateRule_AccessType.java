...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.AccessTypeRuleFunction;
 ...
 * @Date  Jul 18, 2013
 */
public class CreateRule_AccessType extends SetupCase {
	...
	public void executeSetup() {
		new AccessTypeRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_access_type";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Access Type");
