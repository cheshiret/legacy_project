...
import com.activenetwork.qa.awo.supportscripts.function.admin.ormsclientrulefunctions.MinimumWindowRuleFunction;
import com.activenetwork.qa.awo.util.AwoUtil;
import com.activenetwork.qa.testapi.util.StringUtil;
import com.activenetwork.qa.testapi.util.TestProperty;

public class CreateRule_MinimumWindow extends SetupCase {
	...
	public void executeSetup() {
		new MinimumWindowRuleFunction().execute(new Object[] {login, ruleData});
	}
	...
	public void wrapParameters(Object[] param) {
		...
		dataTableName = "d_rule_minimum_window";
		ids = "";
	}
	...
	public void readDataFromDatabase() {
		...
		//rule data info
		ruleData = new RuleDataInfo("Minimum Window");//IMPORTANT
		...
		//Minimum Window specific attributes
		ruleData.length = datasFromDB.get("LENGTHOFSTAY");
		ruleData.unit = datasFromDB.get("Unit");
		ruleData.zeroDayCutOffTime = datasFromDB.get("ZeroDayCutOffTime");
		ruleData.zeroDayUseCheckInTime = datasFromDB.get("ZeroDayUseCheckInTime");
	}
}
