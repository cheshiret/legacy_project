...
public class MaxNumOfPermitsPerPeriodNonProfitOrgRuleFunction extends RuleCommonFunction {
	...
	protected void setRuleSpecificCondition() {
		...
		if(!StringUtil.isEmpty(ruleData.unit)) {
			...
			} else if(ruleData.unit.equalsIgnoreCase("calendar year")) {
				unit = Auto_TimeUnit.CalendarYear;
			}
		}
