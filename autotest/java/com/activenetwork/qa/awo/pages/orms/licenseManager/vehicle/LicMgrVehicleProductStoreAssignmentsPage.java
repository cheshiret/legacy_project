 ...
 * @Date  May 27, 2011
 */
public class LicMgrVehicleProductStoreAssignmentsPage extends LicMgrEditVehicleDetailsPage implements ILicMgrProductAgentAssignmentsPage {
	
	private static LicMgrVehicleProductStoreAssignmentsPage _instance = null;
	
	protected LicMgrVehicleProductStoreAssignmentsPage() {}
	
	public static LicMgrVehicleProductStoreAssignmentsPage getInstance() {
		if(null == _instance) {
			_instance = new LicMgrVehicleProductStoreAssignmentsPage();
		}
	...
	/**
	 * select location class store assignment record check box identified by location class name
