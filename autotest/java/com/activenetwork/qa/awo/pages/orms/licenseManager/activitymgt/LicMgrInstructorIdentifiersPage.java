 ...
 * @Date  Mar 18, 2014
 */
public class LicMgrInstructorIdentifiersPage extends LicMgrInstructorDetailsPage {

	private static LicMgrInstructorIdentifiersPage instance=null;

	private LicMgrInstructorIdentifiersPage(){}

	public static LicMgrInstructorIdentifiersPage getInstance(){
		if(instance==null){
			instance=new LicMgrInstructorIdentifiersPage();
		}
		return instance;
	}
	...
	public String getIdentifierColumnValue(String status, String idenType, String idenNum, String colValue){
		...
		for(int i=1; i<table.rowCount(); i++){
			String statusValue = table.getCellValue(i, col_4);
