...
public class LicMgrConsumableSaleAddItemPage extends LicMgrAddItemPage{

	private static LicMgrConsumableSaleAddItemPage _instance = null;
	
	private LicMgrConsumableSaleAddItemPage(){
	}
	
	public static LicMgrConsumableSaleAddItemPage getInstance(){
		if(_instance == null){
			_instance = new LicMgrConsumableSaleAddItemPage();
		}
		return _instance;
	}
	...
	public int getProductIndex(String prodName) {
		IHtmlObject[] objs = this.getConsumbleProducts();
		IHtmlTable grid = (IHtmlTable) objs[0];
