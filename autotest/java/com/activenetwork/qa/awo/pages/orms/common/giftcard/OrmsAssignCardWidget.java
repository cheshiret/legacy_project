...
/**
 * Click the "Assign Card" button in gift card order detail page, the widget will pop up, this button only exist in operation manager
 * @author Phoebe
 * @Date  July 31,2014
 */
public class OrmsAssignCardWidget extends HtmlPopupPage {
	
	private static OrmsAssignCardWidget _instance;
	
	protected OrmsAssignCardWidget () {
		super("title","Assign Gift Card");
	}
	
	public static OrmsAssignCardWidget getInstance() {
		if(null==_instance) {
			_instance=new OrmsAssignCardWidget();
		}
