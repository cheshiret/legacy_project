 ...
 * @Date  Dec 26, 2011
 */
public class LicMgrSupplyProductContractFeesPage extends LicMgrSupplyProductDetailsPage{
	private static LicMgrSupplyProductContractFeesPage _instance = null;

	private LicMgrSupplyProductContractFeesPage() {
	}

	public static LicMgrSupplyProductContractFeesPage getInstance() {
		if (null == _instance) {
			_instance = new LicMgrSupplyProductContractFeesPage();
		}
