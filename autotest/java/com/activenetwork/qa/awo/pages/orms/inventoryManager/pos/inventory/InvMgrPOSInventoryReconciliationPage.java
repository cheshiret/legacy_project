 ...
 * @Date  Jul 30, 2012
 */
public class InvMgrPOSInventoryReconciliationPage extends InvMgrPOSPhysicalInventoryReconciliationCommonPage {
	
	private static InvMgrPOSInventoryReconciliationPage _instance = null;
	
	private InvMgrPOSInventoryReconciliationPage() {}
	
	public static InvMgrPOSInventoryReconciliationPage getInstance() {
		if(_instance == null) {
			_instance = new InvMgrPOSInventoryReconciliationPage();
		}
	...
	public String getReconciliationID() {
		...
		String ids[] = RegularExpression.getMatches(text, "[0-9]{9,}");
		if(ids.length < 1) {
