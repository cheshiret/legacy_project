 ...
 * @Date  Nov 15, 2013
 */
public class RAUpdateBoatPage extends UwpHeaderBar{
	...
	static class SingletonHolder {
		protected static RAUpdateBoatPage _instance = new RAUpdateBoatPage();
	}

	protected RAUpdateBoatPage() {
	}

	public static RAUpdateBoatPage getInstance() {
	...
	protected Property[] pageTitle(){
		return Property.concatPropertyArray(div(), ".id", "pagetitle", ".text", "Equipment Management - Update Boat");
	}
	
	protected Property[] update(){
		return Property.toPropertyArray(".id", "submitForm_submitForm", ".text", "Update");
	}
	...
	public void updateBoatInfo(Data<BoatAttr> src){
