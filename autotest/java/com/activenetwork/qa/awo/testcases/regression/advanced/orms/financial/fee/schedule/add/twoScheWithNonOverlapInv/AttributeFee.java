...
/**
 * @Description: This case was designed as a boundary case for creating and activating attribute fee schedules, to cover Defect-34432.
 * @Preconditions: 
 * @SPEC:
 * @Task#: Auto-1051
 * 
 ...
 * @Date  May 14, 2012
 */
public class AttributeFee extends FinanceManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		schedule.locationCategory = "Park";
	  	...
	  	schedule.loop = "UPPR";
	  	schedule.productGroup = "RV NONELECTRIC";
	  	schedule.product = "015-015";
	...
	private void addAndActiveFeeSchedule() {
		...
		if (schedule.feeSchdId.length() > 0
			&& finFeeMainPg.isFeeScheduleActive(schedule.feeSchdId)) {
