 ...
 *                applies to Attribute Fee and the Rate Type is Override; Display Discount is checked 
 ...
 * 				d_fin_add_discount:id=1240(DISCOUNTNAME='AddSchedule_AttrFee_Override_OnlyDisplayChecked')
 * @SPEC: [TC:049992] Add Discount Schedule_Override Use/Attribute Fee_Flow
 * @Task#: Auto-1949
 * @author Phoebe
 * @Date  Dec 23, 2013
 */
public class AttrFee_Override_OnlyDisplayChecked  extends FinanceManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		//initialize Discount info
	  	discount.name = "AddSchedule_AttrFee_Override_OnlyDisplayChecked"; //The discount should be added by set up script
	  	discount.rateType = "Override";
	  	discount.behaviors.add("Display Discount");
		
	  	//initialize Schedule data
	  	schedule.rateType = discount.rateType;
