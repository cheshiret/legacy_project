 ...
 *               applies to Transaction Fee and the Rate Type is Flat; Behavior is Automatic Discount is checked, the others are unchecked
 ...
 * 				d_fin_add_discount:id=1200(DISCOUNTNAME='AddSchedule_TransFee_Flat_OnlyAutoChecked')
 * @SPEC:[TC:049989]Add Discount Schedule_Transaction Fee_Flow 
 * @Task#: Auto-1949
 * @author Phoebe
 * @Date  Dec 23, 2013
 */
public class TransactionFee_Flat_OnlyAutoChecked extends FinanceManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		//initialize Discount info
	  	discount.name = "AddSchedule_TransFee_Flat_OnlyAutoChecked"; //The discount should be added by set up script
