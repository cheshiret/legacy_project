 ...
 * @author vzhao
 */
public class UpdateUserAccount_MS extends WebTestCase
{
	/**
	 * Script Name   : <b>UpdateUserAccount_MS</b>
	 * Generated     : <b>Nov 26, 2009 8:44:34 PM</b>
	 * Description   : Functional Test Script
	...
	public void execute() {
		...
		//update email
		String newEmail = web.generateNewWebEmail("ms", env);
	...
	public void wrapParameters(Object[] param) {
		...
		String email = web.generateNewWebEmail("ms", env); //for private lable
