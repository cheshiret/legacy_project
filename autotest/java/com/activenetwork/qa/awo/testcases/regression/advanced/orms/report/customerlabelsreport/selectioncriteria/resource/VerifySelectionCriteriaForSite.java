...
public class VerifySelectionCriteriaForSite extends ResourceManagerTestCase{
	...
	public void execute() {
		...
		verifyReportFormat("ProductCategory",productGroup,"Site",3);
		...
		verifyReportFormat("ReportBy",reportBy,"Stay Date",3);
