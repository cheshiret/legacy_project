...
/**
 * @Description: Modify the store status as inactive.
 * @Preconditions:  The specific vendor is exist.
 * @SPEC:  Deactivate store
 * @Task#: Auto-753
 * @author jwang8
 * @Date  Jan 10, 2012
 * @defect
 */
public class Deactivate extends LicenseManagerTestCase{
	...
	public void execute() {
		...
		//Update the store status as inactive.
