...
/**
 * @Description: This case was designed as a boundary case for creating and activating ticket fee schedules, to cover Defect-34432.
 * @Preconditions: 
 * @SPEC:
 * @Task#: Auto-1051
 * 
 ...
 * @Date  May 14, 2012
 */
public class TicketFee extends FinanceManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		login.contract = "NRRS Contract";
	  	...
	  	schedule.feeType ="Ticket Fee";
		schedule.locationCategory = "Park";
	  	schedule.location = "MAMMOTH CAVE NATIONAL PARK TOURS";
	  	schedule.loop = "All";
	  	schedule.productGroup = "Cave Tour";
	  	schedule.product = "TROG-Trog";
	  	...
	  	schedule.ticketCategory = "All";
	  	schedule.rateType = "Regular";
	  	schedule.ticketUnit = "Per Ticket";
	  	schedule.ticketType = "All";
	  	schedule.nightlyRate = "10.0";
	  	
	  	// Search criteria
	  	schedule.searchType = "Product";
	  	schedule.searchValue = "Trog";
