 ...
 *              d_hf_add_activity:id=120
 * @SPEC:[TC:109718] Add Transaction Fee Schedule for Activity Product 
 * @Task#: Auto-2135
 * @author Phoebe Chen
 * @Date  April 9, 2014
 */
public class Validation_AddTransactionFee extends LicenseManagerTestCase{
	...
	public void execute() {
		...
		this.setScheduleInfo("6.00", new String[] {"Percent", "Amount"}[index], account1, account2, new String[]{"100","0.00"}[index], new String[]{"0.00","6.00"}[index]);
	...
	public void wrapParameters(Object[] param) {
		...
		schedule.product = "Activity fee 09";
		...
		errMsg_duplicateAccount = "Duplicate Accounts for the Transaction Fee Fund Splits is not allowed.";
		errMsg_percentFundValueLessThanZeroOrMoreThanhundred = "A Percentage Fund Split value entered for Transaction Fee is not valid. Please enter a numeric value between 0.00% and 100.00%.";
		errMsg_amountFundValueLessThenZeroOrGreatThanTotal = "An Amount Fund Split value entered for Transaction Fee is not valid. Please enter either a numeric value greater than or equal to $0.00 or select the Balance option.";
	}
