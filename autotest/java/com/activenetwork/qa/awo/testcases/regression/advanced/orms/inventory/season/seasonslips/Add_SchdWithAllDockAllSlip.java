 ...
 *               There has one season with Dock "All" and Slip type "All"
 ...
 * @Date  Mar 11, 2013
 */
public class Add_SchdWithAllDockAllSlip extends
InventoryManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		season.m_StartDate = DateFunctions.getDateAfterToday(2042);
		season.m_EndDate = DateFunctions.getDateAfterToday(2043);
		season.m_Loop = "All";
