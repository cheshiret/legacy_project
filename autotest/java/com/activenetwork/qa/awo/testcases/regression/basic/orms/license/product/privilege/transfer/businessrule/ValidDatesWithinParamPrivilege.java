 ...
 * Error message:
 * Error 1007: Valid Date of {1} must be within the Valid Date of {3}
 ...
 *                (d_hf_add_pri_business_rule, Id:210)
 *                4.Privilege must have license year which is fiscal year
 *                5.Privileges must have valid from/to date.
 ...
 * @Date  Mar 13, 2012
 */
public class ValidDatesWithinParamPrivilege extends LicenseManagerTestCase {
	...
	public void execute(){
		...
		// 1. Precondition check: should not within, will violate rule.
		this.checkValidDateWithin(false);
	...
	public void wrapParameters(Object[] param){
		...
		privilege.code = "971";
		privilege.name = "ValidDatesOverlap";
		...
		parameterPriv.code = "940";
		parameterPriv.name = "ParamPrivilege10";
		...
		String errorCode = "1007";
		expectMsg = "Error "+errorCode+": Valid Date of "+privilege.code+" - "+privilege.name+" must be within the Valid Date of "+parameterPriv.code+" - "+parameterPriv.name + ".*";
	}
