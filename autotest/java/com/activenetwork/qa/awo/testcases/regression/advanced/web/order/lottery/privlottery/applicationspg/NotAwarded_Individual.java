...
/**
 * 
 * @Description:For Not awarded lottery application with Individual Applicant type, 
 * check lottery attributes and entered hunts in account overview, order history and lottery application page
 * @Preconditions:
 * @LinkSetUp:
 * d_web_hf_signupaccount:id=1440--RCMP #|1R9Y4x4199
 * d_hf_add_privilege_prd:id=2640 --LAD,Lottery App Pri 04
 * d_hf_add_pricing:id=3772,4012--Priv, lottery
 * d_hf_assi_pri_to_store:id=1860
 * d_hf_add_prvi_license_year:id=2750
 * d_hf_add_qty_control:id=1840
 * d_hf_add_hunt:id=910 --LAH16
 * d_hf_add_hunt_license_year:id=830
 * d_hf_assign_priv_to_hunt:id=610
 * d_hf_add_hunt_quota:id=320
 * d_hf_add_hunt_location:id=70
 * d_hf_add_weapon:id=50
 * d_hf_add_lottery_prd:id=450 --WLO
 * d_hf_add_lottery_license_year:id=260
 * d_hf_add_lottery_quantity_control:id=260
 * d_hf_assign_lottery_to_store=260
 * d_hf_assi_hunts_to_lottery:id=420
 * d_hf_add_lottery_execution_config:id=230 --WebLottery16Config
 * d_hf_add_lottery_schedule:id=270 --WebLottery16Processing
 ...
 * @Date  Mar 9, 2014
 */
public class NotAwarded_Individual extends HFSKLotteryApplicationTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		cus.identifier.identifierNum = "1R9Y4x4199";
		...
		//lottery info
		lottery.setCode("WLO");
		lottery.setDescription("WebLottery15");
		...
		schedule.setExecutionConfig("WebLottery15Config");
		schedule.setLicenseYear(quota.getLicenseYear());
		schedule.setDescription("WebLottery15Processing");
