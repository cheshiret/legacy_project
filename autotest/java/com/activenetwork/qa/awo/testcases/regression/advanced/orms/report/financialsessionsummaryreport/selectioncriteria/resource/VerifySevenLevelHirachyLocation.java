...
public class VerifySevenLevelHirachyLocation extends ResourceManagerTestCase{
	...
	private void verifyLocationDefaultCorrect() {
		...
		String[] agencyArray = rptCriteriaPg.getAllSelectionCriteria("AgencyID").split("#");
		if (!agencyArray[0].equals(rptCriteriaPg.getAgencyDefaultID())) {
		...
		String[] facilityArray = rptCriteriaPg.getAllSelectionCriteria("FacilityID").split("#");
