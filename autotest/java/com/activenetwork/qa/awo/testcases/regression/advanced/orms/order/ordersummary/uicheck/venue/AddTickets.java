...
public class AddTickets extends VenueManagerTestCase {
	...
	public void verifyOrderSummaryDetails() {
		...
		} else if(!ui.transactions.get(0).equalsIgnoreCase("Add New Ticket")) {
		...
		} else if(!ui.numOfTickets.equalsIgnoreCase("2")) {//2 in total
