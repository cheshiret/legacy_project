 ...
 * @author vzhao
 */
public class CancelRAResFromPL_NY extends WebTestCase
{
	/**
	 * Script Name   : <b>CancelRAResFromPL_NY</b>
	...
	public void execute() {
		web.checkAndReleaseInventory(schema, bd.arrivalDate, 2, false, bd.siteID) ;
	  	// book a reservation from RA for NY state
		web.invokeURL(url);
		web.signIn(email, pw);
		...
		// verify this order and cancel it from NY private site
