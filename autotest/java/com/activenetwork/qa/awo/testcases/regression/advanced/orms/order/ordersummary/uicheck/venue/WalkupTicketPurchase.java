...
public class WalkupTicketPurchase extends VenueManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		ticket.startDate = DateFunctions.formatDate(DateFunctions.getToday(),"EEE MMM d yyyy");
		ticket.quantity = "1";
	...
	public void verifyOrderSummaryDetails() {
		...
		} else if(!ui.transactions.get(0).equalsIgnoreCase("Walk-up Ticket Purchase")) {
