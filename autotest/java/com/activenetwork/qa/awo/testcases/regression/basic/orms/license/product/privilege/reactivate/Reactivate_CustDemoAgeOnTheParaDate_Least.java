 ...
 *              3. add business rule "Customer must be AT LEAST parameter age on the date of Privilege purchase"
 *              4. reactivate privilege order
 *              5. verify message
 * @LinkSetUp:d_hf_add_privilege_prd:id=2770
 *            d_hf_add_cust_profile:id=3060
 * @SPEC:Reactivate Privilege - "Customer Demographic" rule violation [TC:004619] step3
 * @Task#:Auto-2134
 * 
 * @author Vivian
 * @Date  Apr 9, 2014
 */
public class Reactivate_CustDemoAgeOnTheParaDate_Least extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		privilege.code = "RP5";
		privilege.name = "ReactivatePriOrd05";
		...
		cust.identifier.identifierNum="ReactivePri03";
		...
		ruleInfo.parameters[0].onDate =  DateFunctions.getDateAfterToday(-20);
	...
	private void updateCustomerDOB(){
		...
		String dob = DateFunctions.calculateDate(ruleInfo.parameters[0].onDate, paramAge*(-1), 3); 
