...
/**
 * @Description:
 * 1: verify when select Camping & Lodging - Looking for: Tent, the data populated in the campground details page is correct.
 * @Preconditions:
 ...
 * @Date  Nov 2, 2011
 */
public class CampingTent extends RecgovTestCase {
