...
/**
 * @Description: When register vehicle A, add new vehicle B(motor) to A. 
 * 				 Finish order. Go to vehicle order detail page, unassign motor B from A.   
 * @Preconditions: 
...
public class AddNewToParent extends LicenseManagerTestCase {
	...
	public void execute() {
		...
		//Step 1: make first registration of vehicle order.
	...
	public void wrapParameters(Object[] param) {
		...
		parentVehicle.motors.clear();
		parentVehicle.motors.add(this.childVehicle);
