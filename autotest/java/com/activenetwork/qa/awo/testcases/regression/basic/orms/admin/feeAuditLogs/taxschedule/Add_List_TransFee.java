...
/**
 * @Description: It is to check the audit log of adding a tax schedule for list product,transaction fee type:
 ...
 * @Date  Jan 09, 2013
 */
public class Add_List_TransFee extends AdminManagerTestCase{
	...
	public void execute() {
		...
		feeLogs.actionDetails = "Old Tax Schedule ID: None, New Tax Schedule ID: "+schedule.scheduleId+", Tax Name: "+schedule.taxName+", Product Category: "
				+schedule.productCategory+", Applicable Product Category: "+schedule.appPrdCategory + ", Product: "+schedule.product+", Fee Type: "+schedule.feeType;
	...
	public void wrapParameters(Object[] param) {
		...
		TimeZone timeZone = DataBaseFunctions.getContractTimeZone(schema);
	  	//initialize Tax info
	  	tax.taxName = "audit_log_list_trans_fee";
	  	tax.taxCode = "AuditLogListTrans";
	  	tax.taxDescription = "add tax schedule list transaction fee for audit log";
