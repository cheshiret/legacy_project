...
/**
 * @Description:Assign/remove slip from active slip closure(maintenance),check related closed inventory changed accordingly
 * @Preconditions:
 ...
 * @Date  Jan 14, 2014
 */
public class AssignRemoveSlipToMaintenanceClosure extends InventoryManagerTestCase{
	...
	public void execute() {
	    ...
	    checkClosedInv(closure.slipCD[0],closure.startDate, closure.startDate,true);
	    checkClosedInv(slipCode,closure.startDate, closure.endDate,true);
	    checkClosedInv(slipCode,closure.endDate, closure.endDate,false);
	    ...
	    checkClosedInv(slipCode,closure.startDate, closure.startDate,true);
	    checkClosedInv(slipCode,closure.endDate, closure.endDate,false);
	...
	public void wrapParameters(Object[] param) {
	    ...
	    closure.startDate=DateFunctions.getFirstDateOfMonth(DateFunctions.getToday());
	    closure.endDate=DateFunctions.getDateAfterGivenDay(closure.startDate, 10);
