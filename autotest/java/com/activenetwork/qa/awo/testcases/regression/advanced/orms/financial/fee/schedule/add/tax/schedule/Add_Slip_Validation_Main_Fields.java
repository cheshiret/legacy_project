 ...
 * @Preconditions:
 * 1. A tax has been setup:add_slip_schedule_validate_mainFields
 * @SPEC: TC:049782,049783,049784
 * @Task#: Auto-1434
 * @author Phoebe Chen
 * @Date  Jan 09, 2013
 */
public class Add_Slip_Validation_Main_Fields extends FinanceManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		//initialize login finance manager loginInfo
	  	...
	  	//initialize Tax info
	  	tax.taxName = "add_slip_schedule_validate_mainFields";
	  	tax.taxCode = "ValidSlipMain";
	 	...
	 	schedule.product = "All";
	  	...
	  	schedule.startDate = "2019-12-1";
	  	schedule.endDate = "2019-12-31";
