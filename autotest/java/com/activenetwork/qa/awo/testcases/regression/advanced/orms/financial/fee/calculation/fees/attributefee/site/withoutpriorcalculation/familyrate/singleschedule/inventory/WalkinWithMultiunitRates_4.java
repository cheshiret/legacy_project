...
/**
 * use single schedule with multi-unit family rates remian night:If the sum[fee
 * for each night covered in the next multi-unit rate] is greater than the
 * previous multi-unit rate, the System shall apply the previous multi-unit rate
 * to the nights covered by the next multi-unit rate
 * 
 * @author Sophia
 * 
 */
public class WalkinWithMultiunitRates_4 extends InventoryManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		feeData.bookDate = "Thu Jun 03 2010";
		feeData.arriveDate = "Thu Jun 03 2010";
		feeData.departureDate = "Sat Jul 31 2010";
		Map<String, String> unit = new HashMap<String, String>();
		unit.put(RateType.KEY_MONTHRATE, "2");
