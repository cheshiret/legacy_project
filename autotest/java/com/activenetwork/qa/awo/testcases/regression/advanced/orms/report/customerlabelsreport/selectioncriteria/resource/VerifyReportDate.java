...
public class VerifyReportDate extends ResourceManagerTestCase{
	...
	private void reportSectionInfo(){
		...
		errorMessage.add("Reporting period exceeds the maximum report period of 31 days. Please refine the search criteria");//QA4
		                //Report period exceeds the maximum date range allowed. Please enter a date range not exceeding 31 days.
	}
}
