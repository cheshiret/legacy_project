...
/**
 * @Description:check point: make a payment for order work flow(using defer group)
 * @Preconditions:
 * @SPEC:Make Payment
 * @Task#:AUTO-880
 * 
 ...
 * @Date  Mar 16, 2012
 */
public class MakePaymentUseDeferred extends LicenseManagerTestCase {
	...
	public void execute() {
		...
		// set payment (Tendered Payment Amount)
