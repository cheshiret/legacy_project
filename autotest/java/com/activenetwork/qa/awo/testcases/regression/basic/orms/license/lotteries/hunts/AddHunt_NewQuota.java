...
/**
 * @Description:This case is used to verify Add a new hunt, the quota is new added while add the hunt
 * @Preconditions:
 ...
 * @Date Sep 20, 2012
 */
public class AddHunt_NewQuota extends LicenseManagerTestCase{
	...
	public void execute() {
        ...
        //Add a new hunt 
		lm.addHuntFromHuntListPage(quota, null, null, hunt);
