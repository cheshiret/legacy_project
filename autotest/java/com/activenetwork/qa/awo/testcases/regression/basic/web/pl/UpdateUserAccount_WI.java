 ...
 * @author vzhao
 */
public class UpdateUserAccount_WI extends WebTestCase
{
	/**
	 * Script Name   : <b>UpdateUserAccount_WI</b>
	 * Generated     : <b>Nov 26, 2009 8:45:56 PM</b>
	 * Description   : Functional Test Script
	...
	public void execute() {
		...
		//update email
		String newEmail = web.generateNewWebEmail("wi", env);
	...
	public void wrapParameters(Object[] param) {
		...
		String email = web.generateNewWebEmail("wi", env); //for private lable
