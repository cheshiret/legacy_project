...
/**
 * @Description: Purchase a privilege with skip education required info and attested education declaration for multiply education types, 
 * only two education type records for declare generated. 
 * @Preconditions:
 ...
 * @LinkSetUp: 
 * d_web_hf_signupaccount:id=1200
 ...
 * @Date  Dec 5, 2013
 */
public class Edu_SingleProvideAndMultDeclare3 extends HFSKWebTestCase {
	...
	public void execute() {
		...
		// Purchase the privilege to Education Information Required page, and skip this step to Declare page, then finish the purchase
		...
		lm.gotoEducationSubTabFromCustomerDetailsPg();
		this.verifyCustEduExist(true, true, false);
		lm.logOutLicenseManager();
	}
