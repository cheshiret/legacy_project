 ...
 * @Date  Oct 21, 2013
 */
public class VoidBasePri extends LicenseManagerTestCase{
	...
	public void execute() {
		...
		// void base privilege only
		lm.voidLandownerPriInstance(orderNum, privilege.name, "Reverse");
	...
	public void wrapParameters(Object[] param) {
		...
		cust.fName = "QA-Stone";
		cust.lName = "TEST-Guo";
		cust.dateOfBirth = "Mar 09 2001";
		cust.identifier.identifierType = "Passport";
		cust.identifier.identifierNum = "333444111";
