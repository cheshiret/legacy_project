 ...
 * in reservation details page and change reservation confirmation page before and after change date
 * @Preconditions:
 ...
 *                                   Cancellation: $10.00
 * 
 * d_fin_use_attr_fee_sched, id=3640
 * d_fin_tran_fee_sched, id=3280, 3290
 * 
 * @SPEC: Normal reservation change [TC:034894] 
 * @Task#: AUTO-1407
 * 
 * @author SWang
 * @Date  Jan 28, 2013
...
public class NoVoucherProgram extends RecgovTestCase{
	 ...
	 * Initial fee data
	 * @param lengthOfStay
	 * @param isChangingDate  true: fee parameters when changing date
	 *                        false: fee parameter before changing date
	 */
