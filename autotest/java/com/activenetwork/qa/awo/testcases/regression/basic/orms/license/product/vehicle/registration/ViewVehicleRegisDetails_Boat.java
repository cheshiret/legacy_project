...
/**
 * @Description: The case is used to verify the vehicle registration details when register a boat 
 * and view the details page.
 * @Preconditions:
 * 1. Make sure the customer "TEST-Refund QA-Refund" and the vehicle product "REG - RegisterBoat" exist.
 ...
 * @Date  Jun 11, 2012
 */
public class ViewVehicleRegisDetails_Boat extends LicenseManagerTestCase {
	...
	@Override
	public void execute() {
		// Register a boat vehicle and get the creation price and order number
	...
	public void wrapParameters(Object[] param) {
		...
		vehicle.manufacturerPrintName = "YAMA";
