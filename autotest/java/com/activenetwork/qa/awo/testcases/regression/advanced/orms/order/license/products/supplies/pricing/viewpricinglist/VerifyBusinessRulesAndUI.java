package com.activenetwork.qa.awo.testcases.regression.advanced.orms.order.license.products.supplies.pricing.viewpricinglist;
...
/**
 * 
 * @Description:This case is used to verify view supply pricing list. 
...
public class VerifyBusinessRulesAndUI extends LicMgrViewProductPricingListTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		pricing.prodType = "Supplies";
		pricing.prodCode = "888";
		//search critical
