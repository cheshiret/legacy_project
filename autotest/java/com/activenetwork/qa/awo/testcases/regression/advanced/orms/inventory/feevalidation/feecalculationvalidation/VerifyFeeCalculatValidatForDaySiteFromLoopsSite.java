 ...
 *		Deacitve tax schedule:97435861,97435927,97435897   for 'Capital Project Tax' tax
 *		Deacitve tax schedule:97439505,97439959,97439732   for 'Sales Tax' tax
 */

public class VerifyFeeCalculatValidatForDaySiteFromLoopsSite extends InventoryManagerTestCase{
	...
	public void wrapParameters(Object[] args) {
		...
		inventory.loopIDs = new String[]{"10786"};
		inventory.loopNames = new String[]{"Shelter Area A"};
		schema = TestProperty.getProperty(env + ".db.schema.prefix")+"SC";
