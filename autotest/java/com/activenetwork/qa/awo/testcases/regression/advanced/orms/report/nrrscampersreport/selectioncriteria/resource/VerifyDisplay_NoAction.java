...
public class VerifyDisplay_NoAction extends ResourceManagerTestCase{
	...
	public void execute() {
		...
		rm.VerifyReportSelectionCriteria("FacilityID", park, "Carrizo Plain National Monument", park.get(0));
		
		//Verify the section of "Type".
		rm.VerifyReportSelectionCriteria("ReportSubType", type, "Incoming", type.get(0));
		
		//Verify the section of "Short Order".
