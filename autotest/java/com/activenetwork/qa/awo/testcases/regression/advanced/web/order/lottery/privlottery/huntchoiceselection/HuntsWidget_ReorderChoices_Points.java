...
/**
 * @Description: Apply lottery with points, re-order the added hunts in Hunts Widget on Hunt Selection page, and verify the display of the hunts
 * @Preconditions:
 ...
 * @Date  Feb 19, 2014
 */
public class HuntsWidget_ReorderChoices_Points extends HFSKWebTestCase {
	...
	public void execute() {
		...
		cartPg.verifyLotteryHuntChoices(pointType, hunt2.getHuntCode(), hunt3.getHuntCode(), hunt1.getHuntCode());
	...
	private void verifyHuntWidgetChoicesOrder(String firstHunt, String secHunt, String thirdHunt) {
		boolean result = true;
		String[] order = new String[] {"2nd", "3rd", "4th"};
