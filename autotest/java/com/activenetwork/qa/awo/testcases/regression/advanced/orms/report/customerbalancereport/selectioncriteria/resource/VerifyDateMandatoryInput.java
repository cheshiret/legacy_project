...
public class VerifyDateMandatoryInput extends ResourceManagerTestCase{
	...
	public void execute() {
		...
		if(!alertMsg.equals("Missing Required Field:  StartDate, EndDate")){
		...
		if(!alertMsg.equals("Missing Required Field:  StartDate")){
		...
		if(!alertMsg.equals("Missing Required Field:  EndDate")){
