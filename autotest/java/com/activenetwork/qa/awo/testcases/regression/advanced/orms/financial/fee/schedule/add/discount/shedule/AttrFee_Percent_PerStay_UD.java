 ...
 *               applies to Attribute Fee and the Rate Type is Percent; Display Discount is unchecked and Applies to Per Stay
 ...
 * 				d_fin_add_discount:id=1350(DISCOUNTNAME='AddSchedule_AttrFee_Percent_PerStay_UD')
 * @SPEC:[TC:049998] Add Discount Schedule_Use/Attribute Fee Per Stay_Flow 
 * @Task#: Auto-1949
 * @author Phoebe
 * @Date  Dec 23, 2013
 */
public class AttrFee_Percent_PerStay_UD extends FinanceManagerTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		//initialize Discount info
	  	discount.name = "AddSchedule_AttrFee_Percent_PerStay_UD"; //The discount should be added by set up script
