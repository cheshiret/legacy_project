...
public class VerifySelectionCriteriaForTicket extends ResourceManagerTestCase{
	...
	public void execute() {
		...
		verifyReportFormat("ProductCategory",productGroup,"Ticket",3);
		...
		verifyReportFormat("Customer",customer,"Billing Customer",1);
