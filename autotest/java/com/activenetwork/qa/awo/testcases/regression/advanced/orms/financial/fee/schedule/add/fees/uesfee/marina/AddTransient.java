...
/**
 * 
 * @Description: Add a marina fee schedule with "Transient" as Marina Rate Type .
 * @Preconditions:
 * @SPEC:  TC:043375
 * @Task#: Auto-1326
 * 
...
public class AddTransient extends FinanceManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		slipFee1.weeklyFee = "9.0";
		slipFee1.monthlyFee = "50.0";
	...
	private void changeFeeScheduleValue(){
		...
		schedule.nightlyRate = "1.0";
		schedule.weeklyRate = "5.0";
		schedule.monthlyRate = "25.0";
