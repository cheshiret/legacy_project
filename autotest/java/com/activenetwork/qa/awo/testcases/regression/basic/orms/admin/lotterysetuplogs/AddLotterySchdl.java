...
/**
 * @Description:Create a Lottery Schedule of a Slip Lottery in Inventory Manager with NC contract and Goes to admin Manager and check the Inventory Audit Logs of the actions.
 * @Preconditions:
 * @SPEC: [TC:043050]
 * @Task#:AUTO-1345
 * 
 ...
 * @Date  Dec 10, 2012
 */
public class AddLotterySchdl extends AdminManagerTestCase{
