 ...
 * @Date  Apr 19, 2013
 */
public class SetResidentStatus_OverrideAsNON extends HFSKWebTestCase {
	...
	public void execute() {
		...
		privOrderDetailsPage.verifyIdentAndResidentInfo(RESID_STATUS_NON, StringUtil.EMPTY, StringUtil.EMPTY, true);
	...
	public void wrapParameters(Object[] param) {
		cus.email = "mohsk0002@overrideasnon.com"; // with SK address
		cus.password = "asdfasdf";
		cus.fName = "RAJA";
		cus.lName = "UTLEY";
		cus.residencyStatus = RESID_STATUS_SK;
		cus.residencyOverride = RESIDENCY_OVERRIDE_NONRESIDENT; //"Non-Resident Only";
		...
		cus.identifier.identifierNum = "ORDAsNON";
