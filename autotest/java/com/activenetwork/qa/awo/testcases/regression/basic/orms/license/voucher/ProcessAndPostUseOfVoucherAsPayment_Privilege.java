 ...
 * use the voucher as payment.
 * @Preconditions:
 * 1. Make sure the auto approval config is active for the sales location. 
 * 2. Make sure the voucher "TESTPRIVILEGE" exists.
 * 3. Make sure the customer 'QA-Refund, Test-Refund' and the privilege 'COP-CalculateOrderPrice' exist.
 ...
 * @Date  May 29, 2012
 */
public class ProcessAndPostUseOfVoucherAsPayment_Privilege extends
	...
	public void execute() {
		...
		// Make a privilege order and reverse the order to create a new voucher
		...
		// Make another privilege order and use the voucher as payment
		lm.makePrivilegeToCartFromCustomerTopMenu(cust, privilege);
