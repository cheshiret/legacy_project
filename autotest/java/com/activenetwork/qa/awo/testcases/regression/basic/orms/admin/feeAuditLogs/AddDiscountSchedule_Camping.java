...
/**
 * @Description:test audit log for add discount schedule 1.add discount schedule
 *                   in Finance Manager 2.go to admin manager and verify audit
 *                   log in admin mgr
 * 
 * @Preconditions: discount:discount for test Order Create Start Date -- percent
 * 
 * @LinkSetUp: d_fin_add_discount:id=1180
 * 
 * @SPEC:Audit Log [TC:058392]
 * 
 * @Task#:AUTO-1952
 * 
 * @author szhou
 * @Date Dec 18, 2013
 */
public class AddDiscountSchedule_Camping extends AdminManagerTestCase {
	...
	public void execute() {
		...
		feeLogs.searchValue = "New Discount Schedule ID: "
				+ schedule.scheduleId;
		feeLogs.actionDetails = "Old Discount Schedule ID: None, New Discount Schedule ID: "
				+ schedule.scheduleId
				+ ", Discount Name: "
				+ discount.name
				+ ", Product Category: "
				...
				+ ", Product: "
				+ schedule.product + ", Fee Type: " + schedule.feeType;
	...
	public void wrapParameters(Object[] param) {
		...
		feeLogs.action = "Add Discount Schedule";
