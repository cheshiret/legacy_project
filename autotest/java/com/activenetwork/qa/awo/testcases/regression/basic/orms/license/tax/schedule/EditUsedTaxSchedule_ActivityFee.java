 ...
 * @LinkSetUp:  d_hf_add_activity:id=350(ACTIVITY_NAME='Activity For Tax Schedule 07')
 * @SPEC:[TC:110571] Edit Tax Shcedule for Activity Fee  
 * @Task#: Auto-2137
 * @author Phoebe
 * @Date  May 19, 2014
 */
public class EditUsedTaxSchedule_ActivityFee extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		activity.put(ActivityAttr.activityName, "Activity For Tax Schedule 07");
	...
	private void addAnActiveActivityFeeSchedule() {
		...
		feeScheduleListPg.activeFeeSchedule(schedule_Activity.feeSchdId);
		lm.gotoHomePage();
	}
