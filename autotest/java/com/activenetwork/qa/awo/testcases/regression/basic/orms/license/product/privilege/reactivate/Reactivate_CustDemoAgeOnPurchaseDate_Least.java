 ...
 *              5. verify message
 * @LinkSetUp:d_hf_add_privilege_prd:id=2750
 *            d_hf_add_cust_profile:id=3040
 * @SPEC:Reactivate Privilege - "Customer Demographic" rule violation [TC:004619]  step1
 * @Task#:Auto-2134
 * 
 * @author Vivian
 * @Date  Apr 9, 2014
 */
public class Reactivate_CustDemoAgeOnPurchaseDate_Least extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		privilege.code = "RP3";
		privilege.name = "ReactivatePriOrd03";
		...
		cust.identifier.identifierNum="ReactivePri01";
		cust.identifier.state = "Maine";
		
		ruleInfo.status = OrmsConstants.ACTIVE_STATUS;
		ruleInfo.ruleCategory = "Customer Demographic";
		ruleInfo.name = "Customer must be AT LEAST parameter age on the date of Privilege purchase";
