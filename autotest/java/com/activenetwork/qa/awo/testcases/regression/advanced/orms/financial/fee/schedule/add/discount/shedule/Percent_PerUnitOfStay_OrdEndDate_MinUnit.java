 ...
 * @Preconditions:discount info: Percent, per unit of stay
 * @LinkSetUp: d_fin_add_discount:id=1500
 ...
 * @Date  May 12, 2014
 */
public class Percent_PerUnitOfStay_OrdEndDate_MinUnit extends FinanceManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		disSchedule.discountName = "Percent_PerUnitOfStay_OrdEndDate_MinUnit";
