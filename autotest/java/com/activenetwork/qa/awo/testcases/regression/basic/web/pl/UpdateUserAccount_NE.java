 ...
 * @author vzhao
 */
public class UpdateUserAccount_NE extends WebTestCase
{
	/**
	 * Script Name   : <b>UpdateUserAccount_NE</b>
	 * Generated     : <b>Nov 26, 2009 8:44:43 PM</b>
	 * Description   : Functional Test Script
	...
	public void execute() {
		...
		//update email
		String newEmail = web.generateNewWebEmail("ne", env);
	...
	public void wrapParameters(Object[] param) {
		...
		String email = web.generateNewWebEmail("ne", env); //for private lable
