 ...
 * @author QA
 */
public class UpdateUserAccount_LC extends WebTestCase
{
	/**
	 * Script Name   : <b>UpdateUserAccount_LC</b>
	 * Generated     : <b>Apr 22, 2010 4:31:50 AM</b>
	 * Description   : Functional Test Script
	...
	public void execute() {
		...
		//update email
		String newEmail = web.generateNewWebEmail("lc", env);
	...
	public void wrapParameters(Object[] param) {
		...
		String email = web.generateNewWebEmail("lc", env); //for private lable
