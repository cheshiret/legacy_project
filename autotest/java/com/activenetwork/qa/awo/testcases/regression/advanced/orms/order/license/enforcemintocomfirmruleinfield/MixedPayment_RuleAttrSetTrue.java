...
public class MixedPayment_RuleAttrSetTrue extends LicenseManagerTestCase{
	...
	private String locationName,attrName,expMsg;
	...
	public void execute() {
		...
		//used mixed payment type, and payment amount less than minimum payment, verify error message
		...
		//payment amount equal to full payment,process success
		pay.amount = String.valueOf(fullAmount-1);
		pay.additionalAmount = String.valueOf(1);
	...
	public void wrapParameters(Object[] param) {
		...
		vehicle.type = "Boat";
		vehicle.hullIdSerialNum = "MinPayTrueMixedPay"+DataBaseFunctions.getEmailSequence();
	...
	private String processOrderCart(boolean isPopupMessage){	
		...
		if(orderCartPg.checkClickAdditionalPaymentExisting() &&!orderCartPg.additionalPaymentListExists()){
