...
/**
 * 
 * @Description:(P) Verify no Replacement Maximum Allowed in quantity control list, Add and edit quantity control widget when product type as Inventory
 * @LinkSetUp:
 ...
 * @Date  Jan 25, 2014
 */
public class VerifyRMAWithInventoryPrdType extends LicenseManagerTestCase {
