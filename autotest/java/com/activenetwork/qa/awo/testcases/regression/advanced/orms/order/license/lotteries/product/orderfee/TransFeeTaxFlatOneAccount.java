 ...
 * tax: split type=flat 100% to one account
 * @LinkSetUp:
 * D_HF_ADD_LOTTERY_PRD:id=650
 * D_HF_ADD_LOTTERY_QUANTITY_CONT:id=520
 * D_HF_ADD_LOTTERY_LICENSE_YEAR:id=520
 * D_HF_ADD_HUNT:id=1180
 * D_HF_ADD_HUNT_LICENSE_YEAR:id=1360
 * D_HF_ADD_HUNT_QUOTA:id=360
 * D_HF_ASSI_HUNTS_TO_LOTTERY:id=820
 * D_HF_ASSIGN_LOTTERY_TO_STORE:id=520
 ...
 * @Date  Jun 26, 2014
 */
public class TransFeeTaxFlatOneAccount extends LicenseManagerTestCase {
	...
	public void execute() {
		...
		lotteyAppFeesPage.verifyFeeSplitInfo(transactionTaxSchdID,"Tax Fund Split Type: Fee Split");
