 ...
 * @Date  Mar 12, 2012
 */
public class AtLeastParamAgeOnValidDateOfPrivilege extends LicenseManagerTestCase {
	...
	public void wrapParameters(Object[] param){
		...
		cust.fName = "QA-TransferRule25";
		cust.lName = "TEST-TransferRule25";
		...
		toCust.fName = "QA-TransferRule225";
		toCust.lName = "TEST-TransferRule225";
		...
		ruleName = "Customer must be AT LEAST parameter age on the valid date of the Privilege purchased";
