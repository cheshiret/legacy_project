...
/**
 * @Description: Register a vehicle, the customer has an active alert.
 ...
 * @Date  Oct 18, 2012
 */
public class RegisVehicle extends LicenseManagerTestCase {
	...
	public void execute() {
		...
		LicMgrCustomerNoteAndAlertPage addAlertPage = LicMgrCustomerNoteAndAlertPage.getInstance();
		addAlertPage.deactiveAllNoteAlert();
		alertInfo.id = lm.addNoteOrAlertForCustomer(alertInfo);
        
        // verify alert info.
		lm.gotoHomePage();
		String alert = lm.selectCustForRegis(cust, vehicleType);
	...
	public void wrapParameters(Object[] param) {
		...
		cust.dateOfBirth = "19930301";
		cust.lName = "TEST-WhoHasAlert1";
		cust.fName = "Auto-WhoHasAlert1";
		cust.identifier.identifierType = "Green Card";
		cust.identifier.identifierNum = "321654987";
