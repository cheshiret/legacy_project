...
public class RMReportPermission_1 extends AdminManagerTestCase{
    ...
    public void execute(){
 		 //login admin manager and Assign the feature 'AdhocTicketingCubeReport' and UnAssign feature 'ReportManagement'
