...
/**
 * use single schedule with multi-unit rate and family type order meet customer
 * required number of nights,it use customer rate(length of stay:12)
 * 
 * @author Sophia
 * 
 */
public class WalkinWithRequiredMultiunitRates_4 extends
	...
	public void wrapParameters(Object[] param) {
		...
		multi.put(RateType.KEY_CUSTOMERRATE, "1");
