...
/**
 * @Description:This cases verified flow for validation of add a tax schedule for transaction fee
 * @LinkSetUp:  d_hf_add_activity:id=400(ACTIVITY_NAME='Activity For Tax Schedule 12')
 * @SPEC:[TC:110569] Add Tax Shcedule for Transaction Fee  
 * @Task#: Auto-2137
 * @author Phoebe
 * @Date  May 19, 2014
 */
public class Validation_TransactionFee  extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		duplicateSchedule.feeType = "Transaction Fee"; //This is the test point, can not be changed
		duplicateSchedule.productGroup = "FeeAddEditGroup";
		duplicateSchedule.product = "Activity For Tax Schedule 12";
		...
		duplicateSchedule.tranType = "Register for Activity";
	...
	private void setUpSchedule(ScheduleData schedule) {
		schedule.taxName = "TaxForActivity";
	 	...
	 	schedule.product = "Activity For Tax Schedule 12";
