...
public class VerifyReportPermission_3 extends ResourceManagerTestCase{
	...
	public void execute() {
		...
		rm.gotoReportPage();
		//not assign any report feature,report should not be display
		if(rm.checkReportExists(rd.reportName)){
			throw new ErrorOnPageException(rd.reportName+" should not be displayed.");  
		}
		//logout resource manager
		rm.logoutResourceManager();	
		
		//clean up,restore the report feature
	...
	public void wrapParameters(Object[] param) {
		...
		loginAm.contract = "VA Contract";
		loginAm.location = "Administrator/Virginia Department of Conservation and Recreation";
