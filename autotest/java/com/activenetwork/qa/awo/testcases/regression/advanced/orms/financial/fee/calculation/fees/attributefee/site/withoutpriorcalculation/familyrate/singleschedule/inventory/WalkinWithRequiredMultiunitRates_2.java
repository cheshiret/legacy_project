...
/**
 * use single schedule with multi-unit rate and family type order meet week
 * required number of nights,it use weekly rate(length of stay:7)
 * 
 * @author Sophia
 * 
 */
public class WalkinWithRequiredMultiunitRates_2 extends
	...
	public void wrapParameters(Object[] param) {
		...
		feeData.departureDate = "Wed Mar 10 2010";
