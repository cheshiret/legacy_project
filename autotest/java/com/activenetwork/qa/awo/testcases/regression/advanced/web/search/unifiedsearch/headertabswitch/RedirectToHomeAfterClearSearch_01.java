 ...
 * @Date  Nov 10, 2011
 */
public class RedirectToHomeAfterClearSearch_01 extends RecgovTestCase{
...
//		UwpSignInPage singInPg = UwpSignInPage.getInstance();
		...
		UwpSignInSignUpPage signInOrSignUpPg = UwpSignInSignUpPage.getInstance();
		UwpUnifiedSearchHelpInfoPage helpPage=UwpUnifiedSearchHelpInfoPage.getInstance();//Sara[12/3/2013] Update because of new sign in and sign up mode in rec.gov website
