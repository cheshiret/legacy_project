...
/**
 * 
 * @Description:This case is used to verify active vendor. 
 * TODO need to update this case to use an existing vendor after LM going live 
 * @Preconditions:
 * @SPEC:Active Vendor.UCS
 * @Task#:Auto-758

 * @author VZhang
 * @Date Dec 26, 2011
 */
public class ActivateVendor extends LicenseManagerTestCase{
	...
	public void execute() {
		...
		vendor.status = "Inactive-Request Vendor Closure";
		//change vendor status
		lm.changeVendorStauts(vendor.status);
