...
/**
 * 
 * @Description:This case is used to verify edit hunt permit info, Change both the information and the status from Active to Inactive on an Active Record.
 * @Preconditions:
 * Should have an hunt:
 * hunt code = "BEditPInfoOnA";
 * hunt application type = "Individual"
 * @SPEC:   DEFECT-35918 
 * d.Action: Change both the information and the status from Active to Inactive on an Active Record.
...
public class BothChangePermitOnAnActive extends LicenseManagerTestCase{
	...
	public void wrapParameters(Object[] param) {
		...
		hunt.setHuntCode("BEditPInfoOnA");
		hunt.setDescription("BEditPInfoOnA");
