 ...
 * @Date  Mar 7, 2012
 */
public class AtLeastParameterAgeOnPurchasePrivilegeDate2 extends LicenseManagerTestCase {
	...
	public void wrapParameters(Object[] param){
		...
		cust.fName = "QA-TransferRule28";
		cust.lName = "TEST-TransferRule28";// IMPORTANT this customer must be older than 20.
		...
		toCust.fName = "QA-TransferRule228";
		toCust.lName = "TEST-TransferRule228";// IMPORTANT this customer must be younger than 20 and older than 10.
