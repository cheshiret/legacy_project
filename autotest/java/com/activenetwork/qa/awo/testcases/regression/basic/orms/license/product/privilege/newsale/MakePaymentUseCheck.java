...
/**
 * @Description:check point: make a payment for order work flow(using check)
 * @Preconditions:
 * @SPEC:Make Payment
 * @Task#:AUTO-880
 * 
 ...
 * @Date  Apr 27, 2012
 */
public class MakePaymentUseCheck extends LicenseManagerTestCase{
	...
	public void execute() {
		...
		pay.paymentID=payFromDB.paymentID;
	...
	public void wrapParameters(Object[] param) {
		...
		cust.dateOfBirth = "19880329";
		cust.identifier.identifierType = "Green Card";
		cust.identifier.identifierNum = "111196";
		cust.identifier.country = "Canada";
		cust.residencyStatus = "Non Resident";
		cust.fName="TEST-Basic96";
		cust.lName="QA-Basic96";
