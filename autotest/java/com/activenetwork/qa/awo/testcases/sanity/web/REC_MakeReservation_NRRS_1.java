 ...
 */
public class REC_MakeReservation_NRRS_1 extends RecgovTestCase {
	...
	public void wrapParameters(Object[] param) {
		...
		newBd.siteID = "78774";
		newBd.siteNo = DataBaseFunctions.getSiteNum(newBd.siteID, schema);//089
		...
		isSiteTransfer = MiscFunctions.isSiteTransfer("NRSO");
