...
public class Email {
	...
	public Properties[] searchEmail(String mailFolder,Object subjectPattern, Object fromPattern, Object contentPattern, Date sendDate, int dateTreshold, String attachmentPath,String saveAsName, int timeout, boolean delete){
		...
		try {
			...
			if (inbox == null) {
				...
				SearchTerm subject=subjectPattern==null?null:new SubjectTerm(subjectPattern);
				SearchTerm from=fromPattern==null?null:new FromAddressTerm(fromPattern);
				SearchTerm date=sendDate==null?null:new SendDateTerm(sendDate,dateTreshold);
				SearchTerm content=contentPattern==null?null:new TextContentTerm(contentPattern);
	...
	private Properties[] searchEmail(Folder folder, SearchTerm criteria, String attachmentPath,String saveAsName, boolean delete) throws IOException, MessagingException {
		...
		Message[] messages=searchEmailMessages(folder,criteria);
