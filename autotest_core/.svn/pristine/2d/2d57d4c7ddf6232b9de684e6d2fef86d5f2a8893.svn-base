...
//		this.xml=xml;
	...
	private void initValidationCode() {	 
		...
		validationCodes.put("9000", "System error. {0}");
		validationCodes.put("9002", "Unrecognized field code {0}.");
		validationCodes.put("9003", "Field data in the Request does not meet type requirements of Message Version Transaction Field. Version: {0}, Transaction: {1}, Field Code: {2}");
		validationCodes.put("9004", "Field data in the Response does not meet type requirements of Message Version Transaction Field. Version: {0}, Transaction: {1}, Field Code: {2}");
		validationCodes.put("9010", "Product {0} cannot be purchased. Reason: Business rule {1} violated.");
		validationCodes.put("9011", "{0} cannot be found in the system.");
		validationCodes.put("9012", "Mandatory field not provided: {0}.");
		validationCodes.put("9013", "Invalid value specified for field: {0}.");
		validationCodes.put("9014", "Missing field code mapping for property: {0}.");

		// From ORMS H&F Interface - Process Message Spec.
		validationCodes.put("0001", "There is no Standard code assigned to the 2 character field code {0}.");
		validationCodes.put("0002", "There is more than one Standard code assigned to the 2 character field code {0}.");
		...
		validationCodes.put("0026", "There is no Short code assigned to the last 3 characters of the field code {0}.");
		...
		validationCodes.put("0033", "There is no XML element assigned to field code {0}.");
	  // From ORMS H&F Interface - Validate Message Spec.
		validationCodes.put("0106", "Request does not contain mandatory field or the field value is empty. Version: {0}, Transaction: {1}, Field Code: {2}.");
		validationCodes.put("0108", "Response does not contain mandatory field or the field value is empty. Version: {0}, Transaction: {1}, Field Code: {2}.");
		validationCodes.put("0109", "Field data in the Request does not meet minimum length requirements of Message Version Transaction Field. Version: {0}, Transaction: {1}, Field Code: {2}, Min Length: {3}.");
		validationCodes.put("0110", "Field data in the Response does not meet minimum length requirements of Message Version Transaction Field. Version: {0}, Transaction: {1}, Field Code: {2}, Min Length: {3}.");
		validationCodes.put("0111", "Field data in the Request does not meet maximum length requirements of Message Version Transaction Field. Version: {0}, Transaction: {1}, Field Code: {2}, Max Length: {3}.");
		validationCodes.put("0112", "Field data in the Response does not meet maximum length requirements of Message Version Transaction Field. Version: {0}, Transaction: {1}, Field Code: {2}, Max Length: {3}.");
		...
		validationCodes.put("0408", "Not all orders were successfully voided/reversed: {0}.");
		 
		// Proces Sale Request
		validationCodes.put("0511", "No Vehicle found with the Certificate of Number and Serial Number ID provided.");
		validationCodes.put("0517", "Add Customer Profile failed: {0}");
		...
		validationCodes.put("0536", "Processing of the cart failed: {0}");
		...
		validationCodes.put("0654", "Product {0} cannot be purchased. reason: {1}");
		...
		validationCodes.put("0702", "Edit Customer Profile failed: {0}");
		...
		validationCodes.put("0708", "Customer Identifier Type ID is not valid {0}.");
		validationCodes.put("0709", "State/Province is required and is not present or empty for {0}.");
		validationCodes.put("0710", "Country of Identifier Issuance is required and not present or empty for {0}.");
		validationCodes.put("0711", "State/Province provided in the request is not associated with the Country provided in the request for {0}");
		...
		validationCodes.put("0715", "Attribute ID {0} is not a valid Customer Attribute ID for the Contract and Customer Class.");
		...
		validationCodes.put("0905", "Void/Reversal is not successful: {0}");
		...
		validationCodes.put("0917", "Payment was not processed: {0}");
		  
		// Proces Sale Request - Vehicle Inspections
		validationCodes.put("0952", "Product code {0} and Fiscal year {1} combination provided in the request is not in the list determined above.");
